...
<div class="card" id="Brand_Setting">
    ...
    <?php echo e(Form::model($setting, ['route' => 'business.settings', 'method' => 'POST', 'enctype' => 'multipart/form-data'])); ?>
                            ...
                            <div class="setting-card">
                                <div class="logo-content mt-4">
                                    <a href="#" target="_blank">
                                        <img src="<?php echo e(!empty($setting['logo_dark']) ? get_file($setting['logo_dark'], APP_THEME()) . '?timestamp=' . time() : asset(Storage::url('uploads/logo/')) . '/logo-dark.png' . '?timestamp=' . time()); ?>"
                    ...
                    <div class="card">
                        ...
                        <div class="card-body pt-0">
                            <div class=" setting-card">
                                <div class="logo-content mt-4">
                                    <a href="#" target="_blank">
                                        <img src="<?php echo e(!empty($setting['logo_light']) ? get_file($setting['logo_light'], APP_THEME()) . '?timestamp=' . time() : asset(Storage::url('uploads/logo/')) . '/logo-light.png' . '?timestamp=' . time()); ?>"
                    ...
                    <div class="card">
                        ...
                        <div class="card-body pt-0">
                            <div class=" setting-card">
                                <div class="logo-content mt-4">
                                    <a href="#" target="_blank">
                                        <img src="<?php echo e(!empty($setting['favicon']) ? get_file($setting['favicon'], APP_THEME())  . '?timestamp=' . time() : asset(Storage::url('uploads/logo/')) . '/favicon.png' . '?timestamp=' . time()); ?>"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group col-6 col-md-3">
                    <div class="custom-control form-switch p-0">
                        <label class="form-check-label form-label" for="SITE_RTL"><?php echo e(__('Enable RTL')); ?></label><br>
                        <input type="checkbox" class="form-check-input" data-toggle="switchbutton" data-onstyle="primary"
                            name="SITE_RTL" id="SITE_RTL"
                            <?php echo e(isset($setting['SITE_RTL']) && $setting['SITE_RTL'] == 'on' ? 'checked="checked"' : ''); ?>>
                    </div>
                </div>
                <?php if(auth()->user() && auth()->user()->type == 'admin' && $plan && $plan->enable_tax == 'on'): ?>
                    <div class="form-group col-6 col-md-3">
                        <div class="custom-control form-switch p-0">
                            <label class="form-check-label form-label" for="Taxes"><?php echo e(__('Enable Taxes')); ?></label><br>
                            <input type="checkbox" class="form-check-input" data-toggle="switchbutton" data-onstyle="primary"
                                name="taxes" id="Taxes"
                                <?php echo e(isset($setting['taxes']) && $setting['taxes'] == 'on' ? 'checked="checked"' : ''); ?>>
                        </div>
                    </div>
                <?php endif; ?>
                    ...
                    <div class="form-group col-6 col-md-3">
                        <div class="custom-control form-switch p-0">
                            ...
                            <input type="checkbox" class="form-check-input" data-toggle="switchbutton" data-onstyle="primary"
                                ...
                                <?php echo e(isset($setting['display_landing']) && $setting['display_landing'] == 'on' ? 'checked="checked"' : ''); ?>>
                        </div>
                    </div>
                    <div class="form-group col-6 col-md-3">
                        <div class="custom-control form-switch p-0">
                            <label class="form-check-label form-label" for="SIGNUP"><?php echo e(__('Enable Sign-Up Page')); ?></label><br>
                            <input type="checkbox" class="form-check-input" data-toggle="switchbutton" data-onstyle="primary"
                                name="SIGNUP" id="SIGNUP"
                                <?php echo e(isset($setting['SIGNUP']) && $setting['SIGNUP'] == 'on' ? 'checked="checked"' : ''); ?>>
                        </div>
                    </div>
                <?php endif; ?>
                <?php if(auth()->user()->type == 'super admin'): ?>
                    <div class="form-group col-6 col-md-3">
                        <div class="custom-control form-switch p-0">
                            ...
                            <input type="checkbox" name="email_verification" class="form-check-input" id="email_verification"
                                ...
                                <?php echo e(isset($setting['email_verification']) && $setting['email_verification'] == 'on' ? 'checked="checked"' : ''); ?>
                            ...
                            <div class="inner-div">
                                ...
                                <div class="color-wrp">
                                    ...
                                    <div class="color-picker-wrp ">
                                        <input type="color" value="<?php echo e($setting['color'] ?? ''); ?>"
                            ...
                            <div class="inner-div">
                                ...
                                <div class="form-check form-switch mt-2">
                                    <input type="checkbox" class="form-check-input" id="cust_theme_bg" name="cust_theme_bg"
                                        <?php echo e(isset($setting['cust_theme_bg']) && $setting['cust_theme_bg'] == 'on' ? 'checked="checked"' : ''); ?>>
                            ...
                            <div class="inner-div">
                                ...
                                <div class="form-check form-switch mt-2">
                                    <input type="checkbox" class="form-check-input" id="cust-darklayout" name="cust_darklayout"
                                        <?php echo e(isset($setting['cust_darklayout']) && $setting['cust_darklayout'] == 'on' ? 'checked="checked"' : ''); ?> />
                                    <label class="form-check-label f-w-600 pl-1"
...
<!--End Brand Setting--><?php /**PATH B:\xampp\htdocs\ecommers\resources\views/setting/brand_setting.blade.php ENDPATH**/ ?>