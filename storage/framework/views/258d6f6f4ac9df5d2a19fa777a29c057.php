    ...
    <div class="row">
        <div class="col-xxl-4 col-12 mb-4">
            <div class="card m-0 h-100">
                ...
                <h5><b><?php echo e($totaluser); ?> <?php echo e(__('orders')); ?></b></h5>
                </div>
        ...
        <div class="col-xxl-8">
            <div class="card">
                <div class="card-header">
                    <h5><b><?php echo e(__('Customer order Vs Guest order')); ?></b></h5>
                </div>
                <div class="card-body">
...
<div class="col-xxl-12">
    ...
    <div class="card min-h-390 overflow-auto">
        <div class="card-header">
            <h5><b><?php echo e(__('Customer Vs Guest')); ?></b></h5>
        </div>
        <div class="card-body">
...
<?php /**PATH B:\xampp\htdocs\ecommers\resources\views/reports/chart_data.blade.php ENDPATH**/ ?>