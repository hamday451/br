<?php $__env->startSection('page-title', __('Attributes')); ?>

<?php $__env->startSection('action-button'); ?>
    <?php if (app('laratrust')->hasPermission('Create Attributes')) : ?>
    <div class=" text-end d-flex all-button-box justify-content-md-end justify-content-center">
        <a href="#" class="btn btn-sm btn-primary add_attribute" data-ajax-popup="true" data-size="md"
            data-title="<?php echo e(__('Add Attribute')); ?>" data-url="<?php echo e(route('product-attributes.create')); ?>" data-bs-toggle="tooltip"
            title="<?php echo e(__('Add Attribute')); ?>">
...
<?php $__env->startSection('breadcrumb'); ?>
    <li class="breadcrumb-item"><?php echo e(__('Attributes')); ?></li>
<?php $__env->stopSection(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH B:\xampp\htdocs\ecommers\resources\views/attributes/index.blade.php ENDPATH**/ ?>