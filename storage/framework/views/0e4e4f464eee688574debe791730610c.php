                ...
                <table class="cart-tble">
                    <thead>
                        <tr>
                            ...
                            <?php echo $__env->make('front_end.hooks.cart_table_head', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    ...
                    <tbody>
                        <?php if(!empty($response->data->cart_total_product)): ?>
                            ...
                            <tr>
                                ...
                                <?php echo $__env->make('front_end.hooks.cart_table_body', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                ...
                                <td>
                                    <a class="remove_item_from_cart" title="Remove item" data-id="<?php echo e($item->cart_id); ?>">
            ...
            <div class="cart-summery">
                <ul>
                    ...
                    <li>
                        ...
                        <span class="cart-sum-right coupon_discount_amount"><?php echo e(currency_format_with_sym((0) , $store->id, $currentTheme) ?? SetNumberFormat()); ?></span>
                    </li>
                    <?php
...
<?php /**PATH B:\xampp\htdocs\ecommers\resources\views/front_end/sections/pages/cart-list.blade.php ENDPATH**/ ?>