<section class="shop-reviews padding-top padding-bottom" style="position: relative;<?php if(isset($option) && $option->is_hide == 1): ?> opacity: 0.5; <?php else: ?> opacity: 1; <?php endif; ?>" data-index="<?php echo e($option->order ?? ''); ?>" data-id="<?php echo e($option->order ?? ''); ?>" data-value="<?php echo e($option->id ?? ''); ?>" data-hide="<?php echo e($option->is_hide ?? ''); ?>" data-section="<?php echo e($option->section_name ?? ''); ?>"  data-store="<?php echo e($option->store_id ?? ''); ?>" data-theme="<?php echo e($option->theme_id ?? ''); ?>">
    <div class="custome_tool_bar"></div>
    <div class="container">
        <div class="row align-items-center row-gap">
            <div class="col-lg-5 col-md-5 col-12">
                <div class="shop-reviews-left-inner">
                    <div class="new-labl bg-second"  id="<?php echo e($section->variant_background->section->sub_title->slug ?? ''); ?>_preview">
                    <?php echo $section->variant_background->section->sub_title->text ?? ''; ?>

                    </div>
                    <div class="section-title">
                        <h2 class="title" id="<?php echo e($section->variant_background->section->title->slug ?? ''); ?>_preview">
                            <?php echo $section->variant_background->section->title->text ?? ''; ?></h2>
                    </div>
                    <p id="<?php echo e($section->variant_background->section->description->slug ?? ''); ?>_preview"><?php echo $section->variant_background->section->description->text ?? ''; ?> </p>
                    <a href="<?php echo e(route('page.product-list', $slug)); ?>" class="btn"
                        id="<?php echo e($section->variant_background->section->button->slug ?? ''); ?>_preview">
                        ...
                        <?php echo e($section->variant_background->section->button->text ?? ''); ?> <svg
                            ...
                            <div class="review-box-wrapper">
                                <div class="">
                                    <div class="user-pro-list">
                                        <ul class="">
                                            <li>
                                                <img class="<?php echo e(($section->variant_background->section->image->slug ?? '').'_preview'); ?>"
                            src="<?php echo e(get_file($section->variant_background->section->image->image ?? '', $currentTheme)); ?>" alt="user1">
                                            </li>
...
</section><?php /**PATH B:\xampp\htdocs\ecommers\themes\grocery\views/front_end/sections/homepage/variant_section.blade.php ENDPATH**/ ?>