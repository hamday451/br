...
<section class="categories-new" style="position: relative;<?php if($option->is_hide == 1): ?> opacity: 0.5; <?php else: ?> opacity: 1; <?php endif; ?>"
    ...
    <div class="row no-gutters ">
        <?php $__currentLoopData = $home_page_products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

            <div class="col-md-6 col-12">
                <div class="category-card second-look">
                    <?php if($key == '0'): ?>
                        <div class="category-img">
                            <img src="<?php echo e(asset($product->cover_image_path ?? 'themes/grocery/assets/images/menu-product.png')); ?>">
                        </div>
                    <?php else: ?>
                        <div class="category-img">
                            <img src="<?php echo e(asset($product->cover_image_path ?? 'themes/grocery/assets/images/donuts.png')); ?>">
                        </div>
                    <?php endif; ?>
                    <div class="category-card-body">
                        <div class="title-wrapper">
                            <div class="new-labl bg-second">
                                <?php echo e(ucfirst($product->ProductData->name ?? 'New')); ?>

                            </div>
                            <h2><?php echo e($product->name); ?></h2>
                        </div>
                        <div class="btn-wrapper">
                            <a href="<?php echo e(route('page.product-list',  ['storeSlug' => $slug, 'filter_product'=>'created-descending'])); ?>" class="btn" id="<?php echo e($section->newest_category->section->button->slug ?? ''); ?>_preview">
                                <span class="first-icon"><svg width="11" height="11" viewBox="0 0 11 11"
                                    ...
                                    <?php echo $section->newest_category->section->button->text ?? ''; ?> <svg xmlns="http://www.w3.org/2000/svg" width="4"
...
<?php /**PATH B:\xampp\htdocs\ecommers\resources\views/front_end/sections/homepage/newest_category_section.blade.php ENDPATH**/ ?>