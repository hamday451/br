                    ...
                    <div class="mini-cart-item">
                        ...
                        <div class="mini-cart-details">
                            ...
                            <div class="qty-spinner">
                                ...
                                <input type="text" class="quantity 45_quatity" data-cke-saved-name="quantity" name="quantity" value="<?php echo e($item->qty); ?>" min="01" id="cart_quantity<?php echo e($item->qty); ?>" data-id="463" disabled>
                            ...
                            <div class="pvarprice d-flex align-items-center justify-content-between">
                                ...
                                <button class="btn remove_item_from_cart" title="Remove item" data-id="<?php echo e($item->cart_id); ?>">
        ...
        <div class="mini-cart-footer">
            ...
            <div class="mini-cart-footer-total-row d-flex align-items-center justify-content-between">
                ...
                <div class="mini-total-price subtotal">
                    <?php echo e(currency_format_with_sym(($response->data->final_price ?? ($response->data->sub_total ?? 0)), $store->id, $currentTheme) ?? SetNumberFormat($response->data->final_price ?? ($response->data->sub_total ?? 0))); ?>
            ...
            <div class="cart-amount-section">
                ...
                <div class="u-save d-flex justify-end" >
                    <?php echo e(__('Total')); ?> :  <span class="final_amount_currency shipping_total_price" final_total="<?php echo e($response->data->total_sub_price); ?>"><?php echo e(currency_format_with_sym(($response->data->total_sub_price ?? 0), $store->id, $currentTheme) ?? SetNumberFormat($response->data->total_sub_price)); ?></span>
                </div>
            </div>

            <?php echo $__env->make('front_end.hooks.checkout_list', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php /**PATH B:\xampp\htdocs\ecommers\resources\views/front_end/sections/pages/checkout-cart-list.blade.php ENDPATH**/ ?>