                ...
                <div class="my-acc-head">
                    <div class="d-flex justify-content-start back-toshop">
                        <a href="<?php echo e(route('page.product-list',$slug)); ?>" class="back-btn">
                            ...
                            </span> <?php echo e(__('Back to Shop')); ?>

                        </a>
                    </div>
                    <div class="section-title">
                        <h2><?php echo e(__('My Account')); ?></h2>
                    </div>
                </div>
                <div class="row align-items-start">
                    <div class="col-lg-3 col-md-4 col-12 my-acc-column" id="scroll">
                        <div class="my-acc-leftbar">
                            <h4><?php echo e(__('Account Settings')); ?></h4>
                            <ul class="account-list" id="account-nav">
                                <li class="active">
                                    <a href="#tab-1" data-scroll="tab-1">
                                        ...
                                        <span>
                                            <b><?php echo e(__('Edit your account information')); ?></b>
                                            <?php echo e(__('edit your account')); ?>
                                ...
                                <li>
                                    <a href="#tab-2" data-scroll="tab-2">
                                        ...
                                        <span>
                                            <b><?php echo e(__('Change your password')); ?></b>
                                            <?php echo e(__('Change Your Passowrd')); ?>
                                ...
                                <li>
                                    <a href="#tab-3" data-scroll="tab-3">
                                        ...
                                        <span>
                                            <b><?php echo e(__('Modify your address book entries')); ?></b>
                                            <?php echo e(__('Edit your address')); ?>
                                ...
                                <li>
                                    <a href="#tab-4" data-scroll="tab-4">
                                        ...
                                        <span>
                                            <b><?php echo e(__('Support Ticket')); ?></b>
                                            <?php echo e(__('Get support on your order')); ?>
                                ...
                                <li>
                                    <a href="#tab-5" data-scroll="tab-5">
                                        ...
                                        <span>
                                            <b><?php echo e(__('View your order history')); ?></b>
                                            <?php echo e(__('See your order history')); ?>
                                ...
                                <li>
                                    <a href="#tab-6" data-scroll="tab-6">
                                        ...
                                        <span>
                                            <b><?php echo e(__('Your Reward Points')); ?></b>
                                            <?php echo e(__('Count Reward Point')); ?>
                                ...
                                <li>
                                    <a href="#tab-7" data-scroll="tab-7">
                                        ...
                                        <span>
                                            <b><?php echo e(__('View your return requests')); ?></b>
                                            <?php echo e(__('See your Return')); ?>
                                ...
                                <li>
                                    <a href="#tab-8" data-scroll="tab-8">
                                        ...
                                        <span>
                                            <b><?php echo e(__('wishlist')); ?></b>
                                            <?php echo e(__('See your wishlist')); ?>

                                        </span>
                                    </a>
                                </li>
                                <?php echo $__env->make('front_end.hooks.my_account_tab', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                <li class="ogout-link">
                                    <form method="POST" action="<?php echo e(route('customer.logout',$slug)); ?>" id="form_logout">
                                        <?php echo csrf_field(); ?>
                    ...
                    <div class="col-lg-9 col-md-8 col-12">
                        <div class="my-acc-rightbar">
                            <div id="tab-1" class="my-acc-right-content">
                                <div class="section-title">
                                    <h2><?php echo e(__('Your Personal Details')); ?></h2>
                                </div>
                                <div class="form-wrapper">
                                    <?php echo Form::model(auth('customers')->user(), [
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <?php echo Form::text('first_name', null, ['class' => 'form-control', 'placeholder' => 'John']); ?>
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <?php echo Form::text('last_name', null, ['class' => 'form-control', 'placeholder' => 'Doe', 'required' => true]); ?>
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <?php echo Form::number('mobile', null, ['class' => 'form-control', 'placeholder' => '1234567890', 'required' => true]); ?>
                            ...
                            <div id="tab-2" class="my-acc-right-content">
                                <div class="section-title">
                                    <h2><?php echo e(__('Change Password')); ?></h2>
                                </div>
                                <div class="form-wrapper">
                                    <?php echo Form::model(auth('customers')->user(), [
                                    ...
                                    <div class="form-container">
                                        <div class="row">
                                            ...
                                            <input type="hidden" name="type" value="<?php echo e(auth('customers')->user()->type ?? 'customer'); ?>">
                                                <div class="form-group">
                                                    <label><?php echo e(__('Old Password')); ?><sup aria-hidden="true">*</sup>:</label>
                                                    <input name="old_password" value="<?php echo e(old('old_password')); ?>" type="password" class="form-control"
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input name="new_password" value="<?php echo e(old('new_password')); ?>" type="password" class="form-control"
                                                        placeholder="**********" required="">
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    <label><?php echo e(__('Confirm password')); ?><sup
                                                            aria-hidden="true">*</sup>:</label>
                                                    <input name="new_password_confirmation" value="<?php echo e(old('new_password')); ?>" type="password"
                            ...
                            <div id="tab-3" class="my-acc-right-content">
                                ...
                                <div class="section-title"> <h2><?php echo e(__('Address book')); ?></h2> </div>
                                <div class="order-history-frame address-book-div"> </div>
                            </div>

                            <div id="tab-4" class="my-acc-right-content">
                                <div class="section-title"> <h2><?php echo e(__('Support Ticket')); ?></h2> </div>
                                <div class="order-history-frame support-ticket-div">
                                </div>
                            </div>

                            <div id="tab-5" class="my-acc-right-content">
                                <div class="section-title"> <h2><?php echo e(__('Order List')); ?></h2> </div>
                                <div class="order-history-frame order-div"> </div>
                            </div>

                            <div id="tab-6" class="my-acc-right-content">
                                <div class="section-title"> <h2><?php echo e(__('Reward List')); ?></h2> </div>
                                <div class="order-history-frame reward-div"> </div>
                            </div>

                            <div id="tab-7" class="my-acc-right-content">
                                <div class="section-title"> <h2><?php echo e(__('Order return list')); ?></h2> </div>
                                <div class="order-history-frame order-return-div"> </div>
                            </div>

                            <div id="tab-8" class="my-acc-right-content">
                                <div class="section-title">
                                    <h2> <?php echo e(__('Wish list')); ?> <span class="wishcount">[0]</span></h2>
                                </div>
                                <div class="order-confirmation-body wish-list-div"> </div>
                            </div>

                            <?php echo $__env->make('front_end.hooks.my_account_tab_form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        $(document).ready(function(e) {
         ...
         function get_ticket(url = '') {
            if(url == '') {
                url = '<?php echo e(route('support.ticket',$slug)); ?>?page=1';
            }
            var data = {};
            $.ajax({
                url: url,
        ...
        $(document).on('click', '.edit_address', function() {
            ...
            var url = '<?php echo e(route('get.addressbook.data',$slug)); ?>?id='+id;
            $.ajax({
                url: url,
                method: 'GET',
                context:this,
        ...
        $(document).on('click', '.delete_address', function() {
            var id = $(this).attr('data-id');
            var url = '<?php echo e(route('delete.addressbook',$slug)); ?>?id='+id;
            $.ajax({
                url: url,
                method: 'GET',
                context:this,
        ...
        function get_address(url = '') {
            if(url == '') {
                url = '<?php echo e(route('addressbook',$slug)); ?>?page=1';
            }
            var data = {};
            $.ajax({
                url: url,
        ...
        function get_order(url = '') {
            if(url == '') {
                url = '<?php echo e(route('order.list',$slug)); ?>?page=1';
            }
            var data = {};
            $.ajax({
                url: url,
        ...
        function get_order_return(url = '') {
            if(url == '') {
                url = '<?php echo e(route('order.return.list',$slug)); ?>?page=1';
            }
            var data = {};
            $.ajax({
                url: url,
        ...
        function get_reward(url = '') {
            if(url == '') {
                url = '<?php echo e(route('reward.list',$slug)); ?>?page=1';
            }
            var data = {};
            $.ajax({
                url: url,
        ...
        $(document).on('click', '.delete_wishlist', function() {
            var id = $(this).attr('data-id');
            var url = '<?php echo e(route('delete.wishlist',$slug)); ?>?id='+id;
            $.ajax({
                url: url,
                method: 'GET',
                context:this,
...
<?php echo $__env->make('front_end.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH B:\xampp\htdocs\ecommers\resources\views/front_end/sections/pages/my_account.blade.php ENDPATH**/ ?>