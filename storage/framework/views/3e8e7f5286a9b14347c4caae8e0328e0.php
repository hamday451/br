...
<?php $__env->startSection('action-button'); ?>
  <div class=" text-end d-flex all-button-box justify-content-md-end justify-content-center">
    <a href="#" class="btn btn-badge btn-primary" id="submit-all" data-title="<?php echo e(__('Create Product')); ?>" data-toggle="tooltip"
      title="<?php echo e(__('Create Product')); ?>">
      <i class="ti ti-plus drp-icon"></i> <span class="ms-2 me-2"><?php echo e(__('Save')); ?></span> </a>
  </div>
<?php $__env->stopSection(); ?>
<?php
...
<?php $__env->startSection('content'); ?>
  <?php echo e(Form::open(['route' => 'product.store', 'method' => 'post', 'id' => 'choice_form', 'enctype' => 'multipart/form-data'])); ?>
    ...
    <div class="col-md-12">
      <div class="row">
          ...
          <div class="border rounded">
            ...
            <div class="card-body">
              <div class="product-info-top p-3 border-bottom">
                <div class="row row-gap">
                  <div class="col-12">
                    <?php echo Form::label('', __('Name'), ['class' => 'form-label']); ?><span class="text-danger">*</span>
                  ...
                  <div class="col-12 parmalink " style =  "display: none; ">
                    ...
                    <div class="d-flex flex-wrap gap-3">
                      <input class="input-group-text col-12"  readonly id="basic-addon2" value="<?php echo e($link); ?>">
                      <?php echo Form::text('slug', null, ['class' => 'form-control slug col-12']); ?>

                    </div>
                  </div>
                  <div class="col-sm-6 col-12">
                    <?php echo Form::label('', __('Category'), ['class' => 'form-label']); ?><span class="text-danger">*</span>
                    <?php echo Form::select('maincategory_id', $MainCategory, null, [
                        'class' => 'form-control',
                        'data-role' => 'tagsinput',
                        'id' => 'maincategory_id',
                    ]); ?>
                  ...
                  <div class=" col-sm-6 col-12 subcategory_id_div" data_val='0'>
                    ...
                    <span>
                      <?php echo Form::select('subcategory_id', [], null, [
                          'class' => 'form-control',
                          'data-role' => 'tagsinput',
                  ...
                  <div class="col-md-6 col-12">
                    ...
                    <?php echo Form::select('tax_status', $Tax_status, null, [
                        'class' => 'form-control',
                        'data-role' => 'tagsinput',
                        'id' => 'tax_id',
                    ]); ?>
                  ...
                  <div class=" col-sm-6 col-12" data_val='0'>
                    ...
                    <span>
                      <?php echo Form::select('label_id', $labels, null, [
                          'class' => 'form-control',
                          'data-role' => 'tagsinput',
                          'id' => 'label-dropdown',
                      ]); ?>
                  ...
                  <div class="col-sm-6 col-12 product-weight">
                    ...
                    <?php echo Form::number('product_weight', null, ['class' => 'form-control', 'min' => '0', 'step' => '0.01']); ?>

                  </div>
                  <div class="col-md-6 col-12 product_price product-weight">
                    <?php echo Form::label('', __('Price'), ['class' => 'form-label']); ?><span class="text-danger">*</span>
                    <?php echo Form::number('price', null, ['class' => 'form-control', 'min' => '0', 'step' => '0.01']); ?>

                  </div>
                  <div class="col-md-6 col-12 product-weight">
                    <?php echo Form::label('', __('Sale Price'), ['class' => 'form-label']); ?><span class="text-danger">*</span>
                    <?php echo Form::number('sale_price', null, ['class' => 'form-control', 'min' => '0', 'step' => '0.01']); ?>
              ...
              <div class="product-stock-div p-3 pb-0">
                    ...
                    <?php else: ?>
                      <div class="col-md-6 col-12 product_stock">
                        ...
                        <label name="trending" value=""><small>Disabled in <a
                              href="<?php echo e(route('setting.index') . '#Brand_Setting '); ?>"> store
                  ...
                  <?php if($stock_management == 'on'): ?>
                    <div class="row row-gap" id="options">
                      <div class="col-md-6 col-12 product_stock">
                        ...
                        <?php echo Form::number('product_stock', null, ['class' => 'form-control productStock']); ?>

                      </div>
                      <div class="col-md-6 col-12">
                        <?php echo Form::label('', __('Low stock threshold'), ['class' => 'form-label']); ?>

                        <?php echo Form::number('low_stock_threshold', $low_stock_threshold, ['class' => 'form-control', 'min' => '0']); ?>
                  ...
                  <?php endif; ?>
                  <?php echo $__env->yieldPushContent('addCartQuantityControlFilds'); ?>
                    </div>
            ...
            <div class="card p-3 pt-0">
              <div class="card-body">
                <div class="row row-gap">
                  <div class="col-12">
                      <?php echo e(Form::label('sub_images', __('Upload Product Images'), ['class' => 'form-label f-w-800'])); ?><span class="text-danger">*</span>
                        <div class="dropzone dropzone-multiple" data-toggle="dropzone1" data-dropzone-url="http://"
                            ...
                            <div class="dz-message d-flex flex-column mb-2">
                                <img src="<?php echo e(asset('assets/images/notification/upload_icon.png')); ?>" alt="Upload Icon" style="width: 50px; height: 50px; margin:0 auto 10px;">
                    ...
                    <div class="col-12">
                      <label for="cover_image" class="form-label"><?php echo e(__('Upload Cover Image')); ?></label><span class="text-danger">*</span>
                  ...
                  <div class=" col-12" id="downloadable-product-div">
                      <div class="choose-file">
                        <label for="downloadable_product" class="form-label"><?php echo e(__('Downloadable Product')); ?></label>
                  ...
                  <div class=" col-md-6 col-12" id="preview-video-div">
                      <div class="choose-file">
                        <label for="preview_video" class="form-label"><?php echo e(__('Preview Video')); ?></label>
                  ...
                  <div class=" col-md-6 col-12 ml-auto d-none" id="preview-iframe-div">
                    ...
                    <?php echo e(Form::textarea('preview_iframe', null, ['class' => 'form-control font-style', 'rows' => 2])); ?>
                  ...
                  <div class=" col-md-6 col-12" id="video_url_div">
                    ...
                    <?php echo e(Form::text('video_url', null, ['class' => 'form-control font-style'])); ?>
                ...
                <div class="card-body p-3 pb-0 ">
                  <div class="row row-gap">
                    <div class="col-md-12">
                      ...
                      <?php echo Form::select('attribute_id[]', $ProductAttribute, null, [
                      ...
                      <small><?php echo e(__('Choose Existing Attribute')); ?></small>
                    </div>
        ...
        <div class="col-lg-5 col-12">
                        ...
                        <div data-repeater-item>
                          <div class="row">
                            <div class="col-md-6">
                              ...
                              <?php echo Form::text('custom_field', null, ['class' => 'form-control', 'placeholder' => __('Enter Custom Field')]); ?>

                            </div>
                            <div class="col-md-5">
                              <?php echo Form::label('', __('Value'), ['class' => 'form-label']); ?>

                              <?php echo Form::text('custom_value', null, ['id' => 'answer', 'rows' => 2, 'class' => 'form-control','placeholder' => __('Enter Custom Value')]); ?>


                            </div>
                            <div class="col-md-1">
                              <label></label>
                              <a href="javascript:;" data-repeater-delete class="btn field-trash-btn btn-sm btn-light-danger mt-3 mt-md-8 btn-badge"  data-bs-toggle="tooltip" title="<?php echo e(__('Delete')); ?>">
          ...
          <?php echo $__env->yieldPushContent('addsizeguidefields'); ?>
          <?php echo $__env->yieldPushContent('addwholesalefields'); ?>
          <?php echo $__env->yieldPushContent('ProductPageSetting'); ?>
        </div>
...
<?php $__env->startPush('custom-script'); ?>
  ...
  <script>
    ...
    function update_attribute() {
      ...
      $.ajax({
        type: "POST",
        url: '<?php echo e(route('products.attribute_combination')); ?>',
          ...
          $.ajax({
            ...
            success: function(data) {
              ...
              if (data.flag == "success") {
                ...
                window.location.href = "<?php echo e(route('product.index')); ?>" + '?id=1';
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH B:\xampp\htdocs\ecommers\resources\views/product/create.blade.php ENDPATH**/ ?>