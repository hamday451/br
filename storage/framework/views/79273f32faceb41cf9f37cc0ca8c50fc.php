...
<header class="site-header header-style-one" data-index="<?php echo e($option->order ?? ''); ?>" data-id="<?php echo e($option->order ?? ''); ?>" data-value="<?php echo e($option->id ?? ''); ?>" data-hide="<?php echo e($option->is_hide  ?? ''); ?>" data-section="<?php echo e($option->section_name  ?? ''); ?>"  data-store="<?php echo e($option->store_id  ?? ''); ?>" data-theme="<?php echo e($option->theme_id ?? ''); ?>">
    <div class="custome_tool_bar"></div>
    <div class="announcebar">
        <div class="container">
            <div class="announce-row row align-items-center">
                <div class="annoucebar-left col-6 d-flex">
                    <p> <?php echo $section->header->section->title->text ?? ''; ?>

                    </p>
                </div>
                <div class="announcebar-right col-6 d-flex justify-content-end">
                    <a href="tel:<?php echo e($section->header->section->support_value->text ?? '#'); ?>">
                        <span><?php echo e($section->header->section->support_title->text ?? ''); ?> <b> <?php echo e($section->header->section->support_value->text ?? '#'); ?></b></span>
                    </a>
        ...
        <div class="top-header">
            ...
            <div class="right-side-header">
                            ...
                            <div class="menu-dropdown">
                                <ul>
                                    <?php $__currentLoopData = $MainCategoryList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                      <li><a href="<?php echo e(route('page.product-list',[$slug,'main_category' => $category->id ])); ?>"><?php echo e($category->name); ?></a></li>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </ul>
                            </div>
                        </li>
                ...
                <div class="store-info-wrapper">
                    <div class="store-info-block" id="<?php echo e($section->header->section->title->slug ?? ''); ?>_preview"><p><?php echo $section->header->section->title->text ?? ''; ?></p>
                    </div>
                    <div class="store-info-block">
                        <a href="tel:<?php echo e($section->header->section->support_value->text ?? '#'); ?>"><span class="label" id="<?php echo e($section->header->section->support_title->slug ?? ''); ?>_preview"><?php echo e($section->header->section->support_title->text ?? ''); ?></span> <b id="<?php echo e($section->header->section->support_value->slug ?? ''); ?>_preview"><?php echo e($section->header->section->support_value->text ?? ''); ?></b></a>
                    </div>
                </div>
                ...
                <div class="header-info-end">
                    ...
                    <?php if(auth()->guard('customers')->check()): ?>
                        <li class="profile-header">
                            ...
                            <div class="menu-dropdown">
                                <ul>
                                    <li class="menu-lnk has-item"><a href="<?php echo e(route('my-account.index',$slug)); ?>"><?php echo e(__('My Account')); ?></a></li>
                                    <li>
                    ...
                    <?php if(auth()->guard('customers')->check()): ?>
                        <li class="wishlist-header wish-header">
                            <a href="#">
                                ...
                                <span class="count"><?php echo \App\Models\Wishlist::WishCount($currentTheme); ?></span>
                            </a>
                        </li>
                        <?php echo $__env->make('front_end.hooks.header_button', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    <?php endif; ?>
                        <li class="cart-header">
                            <a href="javascript::void(0);">
                            <span class="icon-lable desk-only" > <?php echo e(__('My Cart:')); ?> <b> </b>
                                        ...
                                        <div class="menu-dropdown">
                                            <ul>
                                                <?php $__currentLoopData = $nav->children[0]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $childNav): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    <?php elseif($childNav->type == 'brand'): ?>
                                                        <li><a href="<?php echo e(url($slug.'/'.$childNav->slug)); ?>" target="<?php echo e($childNav->target); ?>">
                                                            <?php if($childNav->title == null): ?>
                                                                <?php echo e($childNav->title); ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH B:\xampp\htdocs\ecommers\themes\grocery\views/front_end/sections/partision/header_section.blade.php ENDPATH**/ ?>