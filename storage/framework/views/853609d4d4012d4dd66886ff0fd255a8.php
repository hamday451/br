...
<?php if (app('laratrust')->hasPermission('Create Blog')) : ?>
    <div class="text-end d-flex all-button-box justify-content-md-end justify-content-center">
        <a href="#" class="btn btn-sm btn-primary" data-ajax-popup="true" data-size="lg" data-title="<?php echo e(__('Add Blog')); ?>"
            data-url="<?php echo e(route('blog.create')); ?>" data-bs-toggle="tooltip" title="<?php echo e(__('Add Blog')); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH B:\xampp\htdocs\ecommers\resources\views/blog/index.blade.php ENDPATH**/ ?>