...
<html>
    ...
    <body>
        ...
        <div id="loader" class="loader-wrapper" style="display: none;">
            ...
            <h3 class="loader-content"> <?php echo e(__('Updating . . .')); ?> </h3>
        </div>

        <script src="<?php echo e(asset('js/loader.js')); ?>"></script>
    </body>
</html>
<?php /**PATH B:\xampp\htdocs\ecommers\resources\views/vendor/installer/layouts/master-update.blade.php ENDPATH**/ ?>