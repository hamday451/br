<?php echo e(Form::open(['route' => 'sub-category.store', 'method' => 'post', 'enctype' => 'multipart/form-data'])); ?>

<div class="row">
    <div class="form-group  col-md-12">
        <?php echo Form::label('sub-category-title', __('Title'), ['class' => 'form-label']); ?>

        <?php echo Form::text('name', null, ['class' => 'form-control', 'id' => 'sub-category-title']); ?>

    </div>
    <div class="form-group  col-md-12">
        <?php echo Form::label('category_id', __('Category'), ['class' => 'form-label']); ?>

        <?php echo Form::select('maincategory_id', $MainCategoryList, null, ['class' => 'form-control', 'data-role' => 'tagsinput', 'id' => 'category_id', 'placeholder' => 'Select Option']); ?>

    </div>

    <div class="form-group col-md-6">
        <?php echo Form::label('upload_image', __('Image'), ['class' => 'form-label']); ?>
    ...
    <div class="form-group col-md-6">
        <?php echo Form::label('upload_icon_image', __('Icon'), ['class' => 'form-label']); ?>
...
<?php /**PATH B:\xampp\htdocs\ecommers\resources\views/subcategory/create.blade.php ENDPATH**/ ?>