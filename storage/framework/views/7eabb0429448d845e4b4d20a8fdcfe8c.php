    ...
    <div class="blog-widget d-flex">
        ...
        <div class="blog-widget-inner">
            <div class="blog-media">
                <span class="new-labl bg-second"><?php echo e($blog->category->name ?? __('Food')); ?></span>
                <a href="<?php echo e(route('page.article',['storeSlug'=>$slug, 'id'=>$blog->id])); ?>">
                    <img src=" <?php echo e(get_file($blog->cover_image_path, $currentTheme)); ?>">
                </a>
            </div>
            <div class="blog-caption">
                <h3><a href="<?php echo e(route('page.article',['storeSlug'=>$slug, 'id'=>$blog->id])); ?>" class="descriptions"><?php echo e($blog->title); ?></a></h3>
                <p><?php echo e($blog->short_description); ?></p>
                <div class="blog-lbl-row d-flex align-items-center justify-content-between">
                    <a class="btn blog-btn" href="<?php echo e(route('page.article',['storeSlug'=>$slug, 'id'=>$blog->id])); ?>">
                        <?php echo e($page_json->blog_page->section->section_sub_button->text ?? __('Read more')); ?>
...
<?php /**PATH B:\xampp\htdocs\ecommers\themes\grocery\views/front_end/sections/homepage/blog_slider.blade.php ENDPATH**/ ?>