<?php $__env->startSection('page-title', __('FAQs')); ?>

<?php $__env->startSection('action-button'); ?>
    <?php if (app('laratrust')->hasPermission('Create Faqs')) : ?>
    <div class="text-end d-flex all-button-box justify-content-md-end justify-content-center">
        <a href="#" class="btn btn-sm btn-primary" data-ajax-popup="true" data-size="md" data-title="<?php echo e(__('Add FAQs')); ?>"
            data-url="<?php echo e(route('faqs.create')); ?>" data-bs-toggle="tooltip" title="<?php echo e(__('Add FAQs')); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH B:\xampp\htdocs\ecommers\resources\views/faq/index.blade.php ENDPATH**/ ?>