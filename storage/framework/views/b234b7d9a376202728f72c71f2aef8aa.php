<div class="mini-cart-header">
    ...
    <div class="cart-tottl-itm"><?php echo e($response->data->cart_total_product); ?> <?php echo e(__('Items')); ?></div>
...
<div id="cart-body" class="mini-cart-has-item">
    <div class="mini-cart-body">
        <?php if(!empty($response->data->cart_total_product)): ?>
            ...
            <div class="mini-cart-item">
                ...
                <div class="mini-cart-details">
                    <p class="mini-cart-title"><a href="<?php echo e(url($slug.'/product/'. getProductSlug($item->product_id))); ?>"><?php echo e($item->name); ?></a></p>
                    ...
                    <div class="qty-spinner">
                        ...
                        <input type="text" class="quantity 45_quatity" data-cke-saved-name="quantity" name="quantity" value="<?php echo e($item->qty); ?>" min="01" id="cart_list_sidebar_quantity_<?php echo e($item->variant_id ?? '-'); ?>_<?php echo e($item->qty); ?>" data-id="463" disabled>
                    ...
                    <div class="pvarprice d-flex align-items-center justify-content-between">
                        <div class="price">
                            <?php echo \App\Models\Product::ManageCartPrice($item, $store, $store->theme_id); ?>

                        </div>
                        <a class="remove_item remove_item_from_cart" title="Remove item" href="#" data-id="<?php echo e($item->cart_id); ?>">
        ...
        <?php else: ?>
            <p class="emptyCart text-center"><?php echo e(__('You have no items in your shopping cart.')); ?></p>
        <?php endif; ?>
    </div>
    <div class="mini-cart-footer mini-cart-footer1">
        <?php if(!empty($response->data->cart_total_product)): ?>
            <div class="u-save d-flex justify-end">
                <?php echo e(__("Subtotal")); ?>: <?php echo e(currency_format_with_sym(($response->data->final_price ?? 0), $store->id, $currentTheme) ?? SetNumberFormat($response->data->final_price ?? ($response->data->sub_total ?? 0))); ?>

            </div>
            <div class="u-save d-flex justify-end">
                <?php echo e(__("Tax")); ?>: <?php echo e(currency_format_with_sym(($response->data->tax_price ?? 0), $store->id, $currentTheme) ?? SetNumberFormat($response->data->tax_price)); ?>
            ...
            <div class="mini-cart-footer-total-row d-flex align-items-center justify-content-between">
                ...
                <div class="mini-total-price">
                    <?php echo e(currency_format_with_sym($final, $store->id, $currentTheme) ?? SetNumberFormat($final)); ?>

                </div>
            </div>
            <a href="<?php echo e(route('page.cart',$slug)); ?>">
                <center>
        ...
        <a href="<?php echo e(route('page.product-list',$slug)); ?>" class="link-btn">
...
<?php /**PATH B:\xampp\htdocs\ecommers\resources\views/front_end/sections/pages/cart-list-sidebar.blade.php ENDPATH**/ ?>