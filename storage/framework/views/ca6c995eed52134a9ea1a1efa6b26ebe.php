<?php echo e(Form::open(['route' => 'product-brand.store', 'method' => 'post', 'enctype' => 'multipart/form-data', 'id'=> 'uploadForm'])); ?>
...
<div class="row">
    <div class="form-group col-md-12">
        ...
        <?php echo Form::text('name', null, ['class' => 'form-control', 'required' => 'true', 'id' => 'name', 'placeholder' => 'Enter Brand Name']); ?>

        <span id="nameError" style="color: red; display: none;"><?php echo e(__('This field is required.')); ?></span>
    </div>
    <div class="form-group col-md-12">
        <div class="row">
            <div class="col-md-6">
    ...
    <div class="form-group col-md-6 d-flex align-items-center gap-2">
        <?php echo Form::label('', __('Status'), ['class' => 'form-label me-2']); ?>
    ...
    <div class="form-group col-md-6 d-flex align-items-center gap-2">
        <?php echo Form::label('', __('Is Popular ?'), ['class' => 'form-label me-2']); ?>
...
<?php /**PATH B:\xampp\htdocs\ecommers\resources\views/product_brand/create.blade.php ENDPATH**/ ?>