...
<div class="card" id="Payment_Setting">
    ...
    <?php echo e(Form::open(['route' => 'payment.settings', 'method' => 'post', 'enctype' => 'multipart/form-data'])); ?>
                                        ...
                                        <div class="row mt-2">
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    ...
                                                    <?php echo Form::textarea('cod_info', empty($setting['cod_info']) ? 'Cash on Delivery' : $setting['cod_info'], [
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <img alt="Image placeholder"
                                                        src="<?php echo e(empty($setting['cod_image']) ? asset(Storage::url('uploads/payment/cod.png')) : get_file($setting['cod_image'], APP_THEME())); ?>"
                                    ...
                                    <div class="row mt-2">
                                        ...
                                        <div class="col-md-6 text-end">
                                            <div class="form-check form-switch d-inline-block">
                                                ...
                                                <label class="custom-control-label form-control-label"
                                                    for="is_bank_transfer_enabled"><?php echo e(__('Bank Transfer Enabled')); ?></label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <img alt="Image placeholder"
                                                    src="<?php echo e(empty($setting['bank_transfer_image']) ? asset(Storage::url('uploads/payment/bank.png')) : get_file($setting['bank_transfer_image'])); ?>"
                                                    class="img-center img-fluid p-1"
                                                    style="max-height: 100px;">
                                            </div>
                                        </div>
                            ...
                            <div id="collapseone_Stripe" class="accordion-collapse collapse"
                                ...
                                <div class="accordion-body">
                                    <div class="row mt-2">
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                <label for="stripe_key" class="form-label"><?php echo e(__('Stripe Publishable Key')); ?></label>
                                                <input class="form-control" placeholder="<?php echo e(__('Enter Stripe Publishable Key')); ?>"
                                                    name="stripe_publishable_key" type="text" value="<?php echo e($setting['stripe_publishable_key'] ?? ''); ?>">
                                            </div>

                                            <div class="form-group">
                                                <label for="stripe_secret" class="form-label"><?php echo e(__('Stripe Secret Key')); ?></label>
                                                <input class="form-control" placeholder="<?php echo e(__('Enter Stripe Secret Key')); ?>"
                                                    name="stripe_secret_key" type="text" value="<?php echo e($setting['stripe_secret_key'] ?? ''); ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <img alt="Image placeholder"
                                                    src="<?php echo e(get_file($setting['stripe_image'] ?? Storage::url('uploads/payment/stripe.png')) ?? asset(Storage::url('uploads/payment/stripe.png'))); ?>"
                                                    class="img-center img-fluid p-1"
                                                    style="max-height: 100px;">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="stripe_unfo"
                                                    class="form-label"><?php echo e(__('Description')); ?></label>
                                                <?php echo Form::textarea('stripe_unfo', $setting['stripe_unfo'] ?? '', [
                                                    'class' => 'autogrow form-control',
                                                    'placeholder' => __('Enter Description'),
                                                    'rows' => '5',
                                                    'id' => 'stripe_unfo',
                                    ...
                                    <div class="row mt-2">
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                <label for="paystack_public_key"
                                                    class="form-label"><?php echo e(__('Paystack Public Key')); ?></label>
                                                <input class="form-control" placeholder="<?php echo e(__('Enter Paystack Public Key')); ?>"
                                                    name="paystack_public_key" type="text"
                                                    value="<?php echo e($setting['paystack_public_key'] ?? ''); ?>">
                                            </div>

                                            <div class="form-group">
                                                <label for="paystack_secret_key"
                                                    class="form-label"><?php echo e(__('Paystack Secret Key')); ?></label>
                                                <input class="form-control" placeholder="<?php echo e(__('Enter Paystack Secret Key')); ?>"
                                                    name="paystack_secret_key" type="text"
                                                    value="<?php echo e($setting['paystack_secret_key'] ?? ''); ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <img alt="Image placeholder"
                                                    src="<?php echo e(get_file($setting['paystack_image'] ?? Storage::url('uploads/payment/paystack.png')) ?? asset(Storage::url('uploads/payment/paystack.png'))); ?>"
                                                    class="img-center img-fluid p-1"
                                                    style="max-height: 100px;">
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="paystack_unfo"
                                                        class="form-label"><?php echo e(__('Description')); ?></label>
                                                    <?php echo Form::textarea('paystack_unfo', $setting['paystack_unfo'] ?? '', [
                                                        'class' => 'autogrow form-control',
                                                        'placeholder' => __('Enter Description'),
                                                        'rows' => '5',
                                                        'id' => 'paystack_unfo',
                                    ...
                                    <div class="row mt-2">
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                <label for="razorpay_public_key"
                                                    class="form-label"><?php echo e(__('Razorpay Public Key')); ?></label>
                                                <input class="form-control"
                                                    placeholder="<?php echo e(__('Enter Razorpay Public Key')); ?>"
                                                    name="razorpay_public_key" type="text"
                                                    value="<?php echo e($setting['razorpay_public_key'] ?? ''); ?>">
                                            </div>

                                            <div class="form-group">
                                                <label for="razorpay_secret_key"
                                                    class="form-label"><?php echo e(__('Razorpay Secret Key')); ?></label>
                                                <input class="form-control"
                                                    placeholder="<?php echo e(__('Enter Razorpay Secret Key')); ?>"
                                                    name="razorpay_secret_key" type="text"
                                                    value="<?php echo e($setting['razorpay_secret_key'] ?? ''); ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <img alt="Image placeholder"
                                                    src="<?php echo e(get_file($setting['razorpay_image'] ?? Storage::url('uploads/payment/razorpay.png')) ?? asset(Storage::url('uploads/payment/razorpay.png'))); ?>"
                                                    class="img-center img-fluid p-1"
                                                    style="max-height: 100px;">
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="razorpay_unfo"
                                                        class="form-label"><?php echo e(__('Description')); ?></label>
                                                    <?php echo Form::textarea('razorpay_unfo', $setting['razorpay_unfo'] ?? '', [
                                                        'class' => 'autogrow form-control',
                                                        'placeholder' => __('Enter Description'),
                                                        'rows' => '5',
                                                        'id' => 'razorpay_unfo',
                                    ...
                                    <div class="row mt-2">
                                                        ...
                                                        <div class="form-check">
                                                            <label class="form-check-labe text-dark">
                                                                <input type="radio"
                                                                    ...
                                                                    class="form-check-input"
                                                                    checked="checked"
                                                                    <?php echo e((isset($setting['mercado_mode']) && $setting['mercado_mode'] == '') || (isset($setting['mercado_mode']) && $setting['mercado_mode'] == 'sandbox') ? 'checked="checked"' : ''); ?>>
                                                        ...
                                                        <div class="form-check">
                                                            <label class="form-check-labe text-dark">
                                                                <input type="radio"
                                                                    ...
                                                                    class="form-check-input"
                                                                    <?php echo e(isset($setting['mercado_mode']) && $setting['mercado_mode'] == 'live' ? 'checked="checked"' : ''); ?>>
                                                                <?php echo e(__('Live')); ?>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label for="mercado_access_token"
                                                    class="col-form-label pt-0"><?php echo e(__('Mercado Access Token')); ?></label>
                                                <input type="text" name="mercado_access_token"
                                                    id="mercado_access_token" class="form-control"
                                                    value="<?php echo e($setting['mercado_access_token'] ?? ''); ?>"
                                                    placeholder="<?php echo e(__('Enter Mercado Access Token')); ?>" />
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <img alt="Image placeholder"
                                                    src="<?php echo e(get_file($setting['mercado_image'] ?? Storage::url('uploads/payment/mercado.png')) ?? asset(Storage::url('uploads/payment/mercado.png'))); ?>"
                                                    class="img-center img-fluid p-1"
                                                    style="max-height: 100px;">
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="mercado_unfo"
                                                        class="form-label"><?php echo e(__('Description')); ?></label>
                                                    <?php echo Form::textarea('mercado_unfo', $setting['mercado_unfo'] ?? '', [
                                                        'class' => 'autogrow form-control',
                                                        'placeholder' => __('Enter Description'),
                                                        'rows' => '5',
                                                        'id' => 'mercado_unfo',
                                    ...
                                    <div class="row mt-2">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="skrill_email"
                                                    ...
                                                    value="<?php echo e($setting['skrill_email'] ?? ''); ?>"
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <img alt="Image placeholder"
                                                    src="<?php echo e(get_file($setting['skrill_image'] ?? Storage::url('uploads/payment/skrill.png')) ?? asset(Storage::url('uploads/payment/skrill.png'))); ?>"
                                                    class="img-center img-fluid p-1"
                                                    style="max-height: 100px;">
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="skrill_unfo"
                                                        class="form-label"><?php echo e(__('Description')); ?></label>
                                                    <?php echo Form::textarea('skrill_unfo', $setting['skrill_unfo'] ?? '', [
                                                        'class' => 'autogrow form-control',
                                                        'placeholder' => __('Enter Description'),
                                                        'rows' => '5',
                                                        'id' => 'skrill_unfo',
                                    ...
                                    <div class="row mt-2">
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                <label for="paymentwall_public_key"
                                                    class="form-label"><?php echo e(__('PaymentWall Public Key')); ?></label>
                                                <input class="form-control"
                                                    placeholder="<?php echo e(__('Enter PaymentWall Public Key')); ?>"
                                                    name="paymentwall_public_key" type="text"
                                                    value="<?php echo e($setting['paymentwall_public_key'] ?? ''); ?>">
                                            </div>

                                            <div class="form-group">
                                                <label for="paymentwall_private_key"
                                                    class="form-label"><?php echo e(__('PaymentWall Private Key')); ?></label>
                                                <input class="form-control"
                                                    placeholder="<?php echo e(__('Enter PaymentWall Private Key')); ?>"
                                                    name="paymentwall_private_key" type="text"
                                                    value="<?php echo e($setting['paymentwall_private_key'] ?? ''); ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <img alt="Image placeholder"
                                                    src="<?php echo e(get_file($setting['paymentwall_image'] ?? Storage::url('uploads/payment/paymentwall.png')) ?? asset(Storage::url('uploads/payment/paymentwall.png'))); ?>"
                                                    class="img-center img-fluid p-1"
                                                    style="max-height: 100px;">
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="paymentwall_unfo"
                                                        class="form-label"><?php echo e(__('Description')); ?></label>
                                                    <?php echo Form::textarea('paymentwall_unfo', $setting['paymentwall_unfo'] ?? '', [
                                                        'class' => 'autogrow form-control',
                                                        'placeholder' => __('Enter Description'),
                                                        'rows' => '5',
                                                        'id' => 'paymentwall_unfo',
                                    ...
                                    <div class="row mt-2">
                                                            ...
                                                            <div class="form-check">
                                                                <label class="form-check-labe text-dark">
                                                                    <input type="radio"
                                                                        ...
                                                                        value="sandbox"
                                                                        class="form-check-input"
                                                                        <?php echo e(!isset($setting['paypal_mode']) || $setting['paypal_mode'] == '' || $setting['paypal_mode'] == 'sandbox' ? 'checked="checked"' : ''); ?>>
                                                                    <?php echo e(__('Sandbox')); ?>
                                                            ...
                                                            <div class="form-check">
                                                                <label class="form-check-labe text-dark">
                                                                    <input type="radio"
                                                                        ...
                                                                        value="live"
                                                                        class="form-check-input"
                                                                        <?php echo e(isset($setting['paypal_mode']) && $setting['paypal_mode'] == 'live' ? 'checked="checked"' : ''); ?>>
                                                                    <?php echo e(__('Live')); ?>
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                <label for="paypal_client_id"
                                                    class="form-label"><?php echo e(__('Paypal Client Key')); ?></label>
                                                <input class="form-control"
                                                    placeholder="<?php echo e(__('Enter Paypal Client Key')); ?>"
                                            ...
                                            <div class="form-group">
                                                <label for="paypal_secret"
                                                    class="form-label"><?php echo e(__('Paypal Secret Key')); ?></label>
                                                <input class="form-control"
                                                    placeholder="<?php echo e(__('Enter Paypal Secret Key')); ?>"
                                                    name="paypal_secret_key" type="text"
                                                    value="<?php echo e($setting['paypal_secret_key'] ?? ''); ?>">
                                            </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <img alt="Image placeholder"
                                                    src="<?php echo e(get_file($setting['paypal_image'] ?? Storage::url('uploads/payment/paypal.png')) ?? asset(Storage::url('uploads/payment/paypal.png'))); ?>"
                                                    class="img-center img-fluid p-1"
                                                    style="max-height: 100px;">
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="paypal_unfo"
                                                        class="form-label"><?php echo e(__('Description')); ?></label>
                                                    <?php echo Form::textarea('paypal_unfo', $setting['paypal_unfo'] ?? '', [
                                                        'class' => 'autogrow form-control',
                                                        'placeholder' => __('Enter Description'),
                                                        'rows' => '5',
                                                        'id' => 'paypal_unfo',
                                    ...
                                    <div class="row mt-2">
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                <label for="public_key"
                                                    class="form-label"><?php echo e(__('Flutterwave Public Key')); ?></label>
                                                <input class="form-control"
                                                    placeholder="<?php echo e(__('Enter Flutterwave Public Key')); ?>"
                                                    name="flutterwave_public_key" type="text"
                                                    value="<?php echo e($setting['flutterwave_public_key'] ?? ''); ?>">
                                            </div>

                                            <div class="form-group">
                                                <label for="flutterwave_secret"
                                                    class="form-label"><?php echo e(__('Flutterwave Secret Key')); ?></label>
                                                <input class="form-control"
                                                    placeholder="<?php echo e(__('Enter Flutterwave Secret Key')); ?>"
                                                    name="flutterwave_secret_key" type="text"
                                                    value="<?php echo e($setting['flutterwave_secret_key'] ?? ''); ?>">
                                            </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <img alt="Image placeholder"
                                                    src="<?php echo e(get_file($setting['flutterwave_image'] ?? Storage::url('uploads/payment/flutterwave.png')) ?? asset(Storage::url('uploads/payment/flutterwave.png'))); ?>"
                                                    class="img-center img-fluid p-1"
                                                    style="max-height: 100px;">
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="flutterwave_unfo"
                                                        class="form-label"><?php echo e(__('Description')); ?></label>
                                                    <?php echo Form::textarea('flutterwave_unfo', $setting['flutterwave_unfo'] ?? '', [
                                                        'class' => 'autogrow form-control',
                                                        'placeholder' => __('Enter Description'),
                                                        'rows' => '5',
                                                        'id' => 'flutterwave_unfo',
                                    ...
                                    <div class="row mt-2">
                                                            ...
                                                            <div class="form-check">
                                                                <label class="form-check-labe text-dark">
                                                                    <input type="radio"
                                                                        ...
                                                                        class="form-check-input"
                                                                        <?php echo e(!isset($setting['paytm_mode']) || $setting['paytm_mode'] == '' || $setting['paytm_mode'] == 'local' ? 'checked="checked"' : ''); ?>>
                                                                    <?php echo e(__('Local')); ?>
                                                            ...
                                                            <div class="form-check">
                                                                <label class="form-check-labe text-dark">
                                                                    <input type="radio"
                                                                        ...
                                                                        value="production"
                                                                        class="form-check-input"
                                                                        <?php echo e(isset($setting['paytm_mode']) && $setting['paytm_mode'] == 'production' ? 'checked="checked"' : ''); ?>>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" placeholder="<?php echo e(__('Enter Merchant ID')); ?>"
                                                    name="paytm_merchant_id" type="text"
                                                    value="<?php echo e($setting['paytm_merchant_id'] ?? ''); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" placeholder="<?php echo e(__('Enter Merchant Key')); ?>"
                                                    name="paytm_merchant_key" type="text"
                                                    value="<?php echo e($setting['paytm_merchant_key'] ?? ''); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" placeholder="<?php echo e(__('Enter Industry Type')); ?>"
                                                    name="paytm_industry_type" type="text"
                                                    value="<?php echo e($setting['paytm_industry_type'] ?? ''); ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <img alt="Image placeholder"
                                                    src="<?php echo e(get_file($setting['paytm_image'] ?? Storage::url('uploads/payment/paytm.png')) ?? asset(Storage::url('uploads/payment/paytm.png'))); ?>"
                                                    class="img-center img-fluid p-1"
                                                    style="max-height: 100px;">
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="paytm_unfo"
                                                        class="form-label"><?php echo e(__('Description')); ?></label>
                                                    <?php echo Form::textarea('paytm_unfo', $setting['paytm_unfo'] ?? '', [
                                                        'class' => 'autogrow form-control',
                                                        'placeholder' => __('Enter Description'),
                                                        'rows' => '5',
                                                        'id' => 'paytm_unfo',
                                    ...
                                    <div class="row mt-2">
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" placeholder="<?php echo e(__('Enter Mollie Api Key')); ?>"
                                                    name="mollie_api_key" type="text"
                                                    value="<?php echo e($setting['mollie_api_key'] ?? ''); ?>">
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control"
                                                    placeholder="<?php echo e(__('Enter Mollie Profile Secret Key')); ?>"
                                                    name="mollie_profile_id" type="text"
                                                    value="<?php echo e($setting['mollie_profile_id'] ?? ''); ?>">
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control"
                                                    placeholder="<?php echo e(__('Enter Mollie Partner Secret Key')); ?>"
                                                    name="mollie_partner_id" type="text"
                                                    value="<?php echo e($setting['mollie_partner_id'] ?? ''); ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <img alt="Image placeholder"
                                                    src="<?php echo e(get_file($setting['mollie_image'] ?? Storage::url('uploads/payment/mollie.png')) ?? asset(Storage::url('uploads/payment/mollie.png'))); ?>"
                                                    class="img-center img-fluid p-1"
                                                    style="max-height: 100px;">
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="mollie_unfo"
                                                        class="form-label"><?php echo e(__('Description')); ?></label>
                                                    <?php echo Form::textarea('mollie_unfo', $setting['mollie_unfo'] ?? '', [
                                                        'class' => 'autogrow form-control',
                                                        'placeholder' => __('Enter Description'),
                                                        'rows' => '5',
                                                        'id' => 'mollie_unfo',
                                    ...
                                    <div class="row mt-2">
                                                            ...
                                                            <div class="form-check">
                                                                <label class="form-check-labe text-dark">
                                                                    <input type="radio"
                                                                        ...
                                                                        value="sandbox"
                                                                        class="form-check-input"
                                                                        <?php echo e(!isset($setting['coingate_mode']) || $setting['coingate_mode'] == '' || $setting['coingate_mode'] == 'sandbox' ? 'checked="checked"' : ''); ?>>
                                                                    <?php echo e(__('Sandbox')); ?>
                                                            ...
                                                            <div class="form-check">
                                                                <label class="form-check-labe text-dark">
                                                                    <input type="radio"
                                                                        ...
                                                                        value="live"
                                                                        class="form-check-input"
                                                                        <?php echo e(isset($setting['coingate_mode']) && $setting['coingate_mode'] == 'live' ? 'checked="checked"' : ''); ?>>
                                                                    <?php echo e(__('Live')); ?>
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control"
                                                    placeholder="<?php echo e(__('Enter CoinGate Auth Token')); ?>"
                                                    name="coingate_auth_token" type="text"
                                                    value="<?php echo e($setting['coingate_auth_token'] ?? ''); ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <img alt="Image placeholder"
                                                    src="<?php echo e(get_file($setting['coingate_image'] ?? Storage::url('uploads/payment/coingate.png')) ?? asset(Storage::url('uploads/payment/coingate.png'))); ?>"
                                                    class="img-center img-fluid p-1"
                                                    style="max-height: 100px;">
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="coingate_unfo"
                                                        class="form-label"><?php echo e(__('Description')); ?></label>
                                                    <?php echo Form::textarea('coingate_unfo', $setting['coingate_unfo'] ?? '', [
                                                        'class' => 'autogrow form-control',
                                                        'placeholder' => __('Enter Description'),
                                                        'rows' => '5',
                                                        'id' => 'coingate_unfo',
                                    ...
                                    <div class="row mt-2">
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control"
                                                    placeholder="<?php echo e(__('Enter Sspay Secret Key')); ?>"
                                                    name="sspay_secret_key" type="text"
                                                    value="<?php echo e($setting['sspay_secret_key'] ?? ''); ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <img alt="Image placeholder"
                                                    src="<?php echo e(get_file($setting['sspay_image'] ?? Storage::url('uploads/payment/sspay.png')) ?? asset(Storage::url('uploads/payment/sspay.png'))); ?>"
                                                    class="img-center img-fluid p-1"
                                                    style="max-height: 100px;">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control"
                                                    placeholder="<?php echo e(__('Enter Category Code')); ?>"
                                                    name="sspay_category_code" type="text"
                                                    value="<?php echo e($setting['sspay_category_code'] ?? ''); ?>">
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="sspay_unfo"
                                                        class="form-label"><?php echo e(__('Description')); ?></label>
                                                    <?php echo Form::textarea('sspay_unfo', $setting['sspay_unfo'] ?? '', [
                                                        'class' => 'autogrow form-control',
                                                        'placeholder' => __('Enter Description'),
                                                        'rows' => '5',
                                                        'id' => 'sspay_unfo',
                                    ...
                                    <div class="row mt-2">
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                <label for="toyyibpay_secret_key"
                                                    class="form-label"><?php echo e(__('Secret Key')); ?></label>
                                                <input class="form-control"
                                                    placeholder="<?php echo e(__('Enter Toyyibpay Secret Key')); ?>"
                                                    name="toyyibpay_secret_key" type="text"
                                                    value="<?php echo e($setting['toyyibpay_secret_key'] ?? ''); ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <img alt="Image placeholder"
                                                    src="<?php echo e(get_file($setting['toyyibpay_image'] ?? Storage::url('uploads/payment/toyyibpay.png')) ?? asset(Storage::url('uploads/payment/toyyibpay.png'))); ?>"
                                                    class="img-center img-fluid p-1"
                                                    style="max-height: 100px;">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control"
                                                    ...
                                                    value="<?php echo e($setting['toyyibpay_category_code'] ?? ''); ?>">
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="toyyibpay_unfo"
                                                        class="form-label"><?php echo e(__('Description')); ?></label>
                                                    <?php echo Form::textarea('toyyibpay_unfo', $setting['toyyibpay_unfo'] ?? '', [
                                                        'class' => 'autogrow form-control',
                                                        'placeholder' => __('Enter Description'),
                                                        'rows' => '5',
                                                        'id' => 'toyyibpay_unfo',
                                    ...
                                    <div class="row mt-2">
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control"
                                                    placeholder="<?php echo e(__('Enter Paytab Profile ID')); ?>"
                                                    name="paytabs_profile_id" type="text"
                                                    value="<?php echo e($setting['paytabs_profile_id'] ?? ''); ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <img alt="Image placeholder"
                                                    src="<?php echo e(get_file($setting['paytabs_image'] ?? Storage::url('uploads/payment/paytabs.png')) ?? asset(Storage::url('uploads/payment/paytabs.png'))); ?>"
                                                    class="img-center img-fluid p-1"
                                                    style="max-height: 100px;">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control"
                                                    placeholder="<?php echo e(__('Enter Paytab Server Key')); ?>"
                                                    name="paytabs_server_key" type="text"
                                                    value="<?php echo e($setting['paytabs_server_key'] ?? ''); ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control"
                                                    placeholder="<?php echo e(__('Enter Paytabs Region')); ?>"
                                                    name="paytabs_region" type="text"
                                                    value="<?php echo e($setting['paytabs_region'] ?? ''); ?>">
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="paytabs_unfo"
                                                        class="form-label"><?php echo e(__('Description')); ?></label>
                                                    <?php echo Form::textarea('paytabs_unfo', $setting['paytabs_unfo'] ?? '', [
                                                        'class' => 'autogrow form-control',
                                                        'placeholder' => __('Enter Description'),
                                                        'rows' => '5',
                                                        'id' => 'paytabs_unfo',
                                    ...
                                    <div class="row mt-2">
                                                        ...
                                                        <div class="form-check">
                                                            <label class="form-check-labe text-dark">
                                                                <input type="radio"
                                                                    ...
                                                                    checked="checked"
                                                                    class="form-check-input"
                                                                    <?php echo e((isset($setting['iyzipay_mode']) && $setting['iyzipay_mode'] == '') || (isset($setting['iyzipay_mode']) && $setting['iyzipay_mode'] == 'sandbox') ? 'checked="checked"' : ''); ?>>
                                                                <?php echo e(__('Sandbox')); ?>
                                                        ...
                                                        <div class="form-check">
                                                            <label class="form-check-labe text-dark">
                                                                <input type="radio"
                                                                    ...
                                                                    class="form-check-input"
                                                                    <?php echo e(isset($setting['iyzipay_mode']) && $setting['iyzipay_mode'] == 'live' ? 'checked="checked"' : ''); ?>>
                                                                <?php echo e(__('Live')); ?>
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" placeholder="<?php echo e(__('Enter Private Key')); ?>"
                                                    name="iyzipay_private_key" type="text"
                                                    value="<?php echo e($setting['iyzipay_private_key'] ?? ''); ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="iyzipay_secret_key"
                                                    class="col-form-label"><?php echo e(__('Secret Key')); ?></label>
                                                <input class="form-control" placeholder="<?php echo e(__('Enter Secret Key')); ?>"
                                                    name="iyzipay_secret_key" type="text"
                                                    value="<?php echo e($setting['iyzipay_secret_key'] ?? ''); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <img alt="Image placeholder"
                                                    src="<?php echo e(get_file($setting['iyzipay_image'] ?? Storage::url('uploads/payment/iyzipay.png')) ?? asset(Storage::url('uploads/payment/iyzipay.png'))); ?>"
                                                    class="img-center img-fluid p-1"
                                                    style="max-height: 100px;">
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="iyzipay_unfo"
                                                        class="form-label"><?php echo e(__('Description')); ?></label>
                                                    <?php echo Form::textarea('iyzipay_unfo', $setting['iyzipay_unfo'] ?? '', [
                                                        'class' => 'autogrow form-control',
                                                        'placeholder' => __('Enter Description'),
                                                        'rows' => '5',
                                                        'id' => 'iyzipay_unfo',
                                    ...
                                    <div class="row mt-2">
                                                            ...
                                                            <div class="form-check">
                                                                <label class="form-check-labe text-dark">
                                                                    <input type="radio"
                                                                        ...
                                                                        checked="checked"
                                                                        class="form-check-input"
                                                                        <?php echo e((isset($setting['payfast_mode']) && $setting['payfast_mode'] == '') || (isset($setting['payfast_mode']) && $setting['payfast_mode'] == 'sandbox') ? 'checked="checked"' : ''); ?>>
                                                                    <?php echo e(__('Sandbox')); ?>
                                                            ...
                                                            <div class="form-check">
                                                                <label class="form-check-labe text-dark">
                                                                    <input type="radio"
                                                                        ...
                                                                        value="live"
                                                                        class="form-check-input"
                                                                        <?php echo e(isset($setting['payfast_mode']) && $setting['payfast_mode'] == 'live' ? 'checked="checked"' : ''); ?>>
                                                                    <?php echo e(__('Live')); ?>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" placeholder="<?php echo e(__('Enter Merchant ID')); ?>"
                                                    ...
                                                    value="<?php echo e($setting['payfast_merchant_id'] ?? ''); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" placeholder="<?php echo e(__('Enter Merchant Key')); ?>"
                                                    ...
                                                    value="<?php echo e($setting['payfast_merchant_key'] ?? ''); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control"
                                                    placeholder="<?php echo e(__('Enter Salt Passphrase Key')); ?>"
                                                    name="payfast_salt_passphrase" type="text"
                                                    value="<?php echo e($setting['payfast_salt_passphrase'] ?? ''); ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <img alt="Image placeholder"
                                                    src="<?php echo e(get_file($setting['payfast_image'] ?? Storage::url('uploads/payment/payfast.png')) ?? asset(Storage::url('uploads/payment/payfast.png'))); ?>"
                                                    class="img-center img-fluid p-1"
                                                    style="max-height: 100px;">
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="payfast_unfo"
                                                        class="form-label"><?php echo e(__('Description')); ?></label>
                                                    <?php echo Form::textarea('payfast_unfo', $setting['payfast_unfo'] ?? '', [
                                                        'class' => 'autogrow form-control',
                                                        'rows' => '5',
                                                        'placeholder' => __('Enter Description'),
                                                        'id' => 'payfast_unfo',
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control"
                                                    ...
                                                    value="<?php echo e($setting['benefit_private_key'] ?? ''); ?>">
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <input class="form-control"
                                                    ...
                                                    value="<?php echo e($setting['benefit_secret_key'] ?? ''); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <img alt="Image placeholder"
                                                    src="<?php echo e(get_file($setting['benefit_image'] ?? Storage::url('uploads/payment/benefit.png')) ?? asset(Storage::url('uploads/payment/benefit.png'))); ?>"
                                                    class="img-center img-fluid p-1"
                                                    style="max-height: 100px;">
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="benefit_unfo"
                                                        class="form-label"><?php echo e(__('Description')); ?></label>
                                                    <?php echo Form::textarea('benefit_unfo', $setting['benefit_unfo'] ?? '', [
                                                        'class' => 'autogrow form-control',
                                                        'placeholder' => __('Enter Description'),
                                                        'rows' => '5',
                                                        'id' => 'benefit_unfo',
                                    ...
                                    <div class="row mt-2">
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control"
                                                    placeholder="<?php echo e(__('Enter Cashfree Key')); ?>" name="cashfree_key"
                                                    type="text"
                                                    value="<?php echo e($setting['cashfree_key'] ?? ''); ?>">
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <input class="form-control"
                                                    ...
                                                    value="<?php echo e($setting['cashfree_secret_key'] ?? ''); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <img alt="Image placeholder"
                                                    src="<?php echo e(get_file($setting['cashfree_image'] ?? Storage::url('uploads/payment/cashfree.png')) ?? asset(Storage::url('uploads/payment/cashfree.png'))); ?>"
                                                    class="img-center img-fluid p-1"
                                                    style="max-height: 100px;">
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="cashfree_unfo"
                                                        class="form-label"><?php echo e(__('Description')); ?></label>
                                                    <?php echo Form::textarea('cashfree_unfo', $setting['cashfree_unfo'] ?? '', [
                                                        'class' => 'autogrow form-control',
                                                        'placeholder' => __('Enter Description'),
                                                        'rows' => '5',
                                                        'id' => 'cashfree_unfo',
                                    ...
                                    <div class="row mt-2">
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" placeholder="<?php echo e(__('Enter Store ID')); ?>"
                                                    name="aamarpay_store_id" type="text"
                                                    value="<?php echo e($setting['aamarpay_store_id'] ?? ''); ?>">
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <input class="form-control"
                                                    ...
                                                    value="<?php echo e($setting['aamarpay_signature_key'] ?? ''); ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="aamarpay_description"
                                                    class="col-form-label"><?php echo e(__('Aamarpay Description')); ?></label>
                                                <input class="form-control"
                                                    placeholder="<?php echo e(__('Enter Aamarpay Description')); ?>"
                                                    name="aamarpay_description" type="text"
                                                    value="<?php echo e($setting['aamarpay_description'] ?? ''); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <img alt="Image placeholder"
                                                    src="<?php echo e(get_file($setting['aamarpay_image'] ?? Storage::url('uploads/payment/aamarpay.png')) ?? asset(Storage::url('uploads/payment/aamarpay.png'))); ?>"
                                                    class="img-center img-fluid p-1"
                                                    style="max-height: 100px;">
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="aamarpay_unfo"
                                                        class="form-label"><?php echo e(__('Description')); ?></label>
                                                    <?php echo Form::textarea('aamarpay_unfo', $setting['aamarpay_unfo'] ?? '', [
                                                        'class' => 'autogrow form-control',
                                                        'placeholder' => __('Enter Description'),
                                                        'rows' => '5',
                                                        'id' => 'aamarpay_unfo',
                                        ...
                                        <div class="row mt-2">
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control"
                                                        placeholder="<?php echo e(__('Enter Telegram Access Token')); ?>"
                                                        name="telegram_access_token" type="text"
                                                        value="<?php echo e($setting['telegram_access_token'] ?? ''); ?>">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" placeholder="<?php echo e(__('Enter Telegram Chat ID')); ?>"
                                                        name="telegram_chat_id" type="text"
                                                        value="<?php echo e($setting['telegram_chat_id'] ?? ''); ?>">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <img alt="Image placeholder"
                                                        src="<?php echo e(get_file($setting['telegram_image'] ?? Storage::url('uploads/payment/telegram.png')) ?? asset(Storage::url('uploads/payment/telegram.png'))); ?>"
                                                        class="img-center img-fluid p-1"
                                                        style="max-height: 100px;">
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="telegram_unfo"
                                                            class="form-label"><?php echo e(__('Description')); ?></label>
                                                        <?php echo Form::textarea('telegram_unfo', $setting['telegram_unfo'] ?? '', [
                                                            'class' => 'autogrow form-control',
                                                            'placeholder' => __('Enter Description'),
                                                            'rows' => '5',
                                                            'id' => 'telegram_unfo',
                                        ...
                                        <div class="row mt-2">
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    <input type="text" name="whatsapp_number"
                                                        ...
                                                        value="<?php echo e($setting['whatsapp_number'] ?? ''); ?>"
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <img alt="Image placeholder"
                                                        src="<?php echo e(get_file($setting['whatsapp_image'] ?? Storage::url('uploads/payment/whatsapp.png')) ?? asset(Storage::url('uploads/payment/whatsapp.png'))); ?>"
                                                        class="img-center img-fluid p-1"
                                                        style="max-height: 100px;">
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="whatsapp_unfo"
                                                            class="form-label"><?php echo e(__('Description')); ?></label>
                                                        <?php echo Form::textarea('whatsapp_unfo', $setting['whatsapp_unfo'] ?? '', [
                                                            'class' => 'autogrow form-control',
                                                            'placeholder' => __('Enter Description'),
                                                            'rows' => '5',
                                                            'id' => 'whatsapp_unfo',
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control"
                                                    ...
                                                    value="<?php echo e($setting['paytr_merchant_id'] ?? ''); ?>">
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <input class="form-control"
                                                    ...
                                                    value="<?php echo e($setting['paytr_merchant_key'] ?? ''); ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="paytr_salt_key"
                                                    class="col-form-label"><?php echo e(__('Salt Passphrase')); ?></label>
                                                <input class="form-control"
                                                    placeholder="<?php echo e(__('Enter Salt Passphrase Key')); ?>" name="paytr_salt_key"
                                                    type="text"
                                                    value="<?php echo e($setting['paytr_salt_key'] ?? ''); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <img alt="Image placeholder"
                                                    src="<?php echo e(get_file($setting['paytr_image'] ?? Storage::url('uploads/payment/paytr.png')) ?? asset(Storage::url('uploads/payment/paytr.png'))); ?>"
                                                    class="img-center img-fluid p-1"
                                                    style="max-height: 100px;">
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="paytr_unfo"
                                                        class="form-label"><?php echo e(__('Description')); ?></label>
                                                    <?php echo Form::textarea('paytr_unfo', $setting['paytr_unfo'] ?? '', [
                                                        'class' => 'autogrow form-control',
                                                        'placeholder' => __('Enter Description'),
                                                        'rows' => '5',
                                                        'id' => 'paytr_unfo',
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control"
                                                    ...
                                                    value="<?php echo e($setting['yookassa_shop_id_key'] ?? ''); ?>">
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <input class="form-control"
                                                    ...
                                                    value="<?php echo e($setting['yookassa_secret_key'] ?? ''); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <img alt="Image placeholder"
                                                    src="<?php echo e(get_file($setting['yookassa_image'] ?? Storage::url('uploads/payment/yookassa.png')) ?? asset(Storage::url('uploads/payment/yookassa.png'))); ?>"
                                                    class="img-center img-fluid p-1"
                                                    style="max-height: 100px;">
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="yookassa_unfo"
                                                        class="form-label"><?php echo e(__('Description')); ?></label>
                                                    <?php echo Form::textarea('yookassa_unfo', $setting['yookassa_unfo'] ?? '', [
                                                        'class' => 'autogrow form-control',
                                                        'placeholder' => __('Enter Description'),
                                                        'rows' => '5',
                                                        'id' => 'yookassa_unfo',
                                    ...
                                    <div class="row mt-2">
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" placeholder="<?php echo e(__('Enter Xendit Api Key')); ?>"
                                                    name="Xendit_api_key" type="text"
                                                    value="<?php echo e($setting['Xendit_api_key'] ?? ''); ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="Xendit_secret_key"
                                                    class="col-form-label"><?php echo e(__('Xendit Token Key')); ?></label>
                                                <input class="form-control"
                                                    placeholder="<?php echo e(__('Enter Xendit Token Key')); ?>"
                                                    name="Xendit_token_key" type="text"
                                                    value="<?php echo e($setting['Xendit_token_key'] ?? ''); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <img alt="Image placeholder"
                                                    src="<?php echo e(get_file($setting['Xendit_image'] ?? Storage::url('uploads/payment/xendit.png')) ?? asset(Storage::url('uploads/payment/xendit.png'))); ?>"
                                                    class="img-center img-fluid p-1"
                                                    style="max-height: 100px;">
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="Xendit_unfo"
                                                        class="form-label"><?php echo e(__('Description')); ?></label>
                                                    <?php echo Form::textarea('Xendit_unfo', $setting['Xendit_unfo'] ?? '', [
                                                        'class' => 'autogrow form-control',
                                                        'placeholder' => __('Enter Description'),
                                                        'rows' => '5',
                                                        'id' => 'Xendit_unfo',
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control"
                                                    ...
                                                    value="<?php echo e($setting['midtrans_secret_key'] ?? ''); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <img alt="Image placeholder"
                                                    src="<?php echo e(get_file($setting['midtrans_image'] ?? Storage::url('uploads/payment/midtrans.png')) ?? asset(Storage::url('uploads/payment/midtrans.png'))); ?>"
                                                    class="img-center img-fluid p-1"
                                                    style="max-height: 100px;">
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="midtrans_unfo"
                                                        class="form-label"><?php echo e(__('Description')); ?></label>
                                                    <?php echo Form::textarea('midtrans_unfo', $setting['midtrans_unfo'] ?? '', [
                                                        'class' => 'autogrow form-control',
                                                        'placeholder' => __('Enter Description'),
                                                        'rows' => '5',
                                                        'id' => 'midtrans_unfo',
                            ...
                            <div id="collapseone_nepalste" class="accordion-collapse collapse"
                                ...
                                <div class="accordion-body">
                                    <div class="row mt-2">
                                        ...
                                        <div class="col-md-6 text-end">
                                            <?php echo Form::hidden('is_nepalste_enabled', 'off'); ?>
                                                        ...
                                                        <div class="form-check">
                                                            <label class="form-check-labe text-dark">
                                                                <input type="radio"
                                                                    ...
                                                                    class="form-check-input"
                                                                    checked="checked"
                                                                    <?php echo e((isset($setting['nepalste_mode']) && $setting['nepalste_mode'] == '') || (isset($setting['nepalste_mode']) && $setting['nepalste_mode'] == 'sandbox') ? 'checked="checked"' : ''); ?>>
                                                                <?php echo e(__('Sandbox')); ?>
                                                        ...
                                                        <div class="form-check">
                                                            <label class="form-check-labe text-dark">
                                                                <input type="radio"
                                                                    ...
                                                                    class="form-check-input"
                                                                    <?php echo e(isset($setting['nepalste_mode']) && $setting['nepalste_mode'] == 'live' ? 'checked="checked"' : ''); ?>>
                                                                <?php echo e(__('Live')); ?>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control"
                                                    placeholder="<?php echo e(__('Enter Public Key')); ?>"
                                                    name="nepalste_public_key" type="text"
                                                    value="<?php echo e($setting['nepalste_public_key'] ?? ''); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control"
                                                    ...
                                                    value="<?php echo e($setting['nepalste_secret_key'] ?? ''); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <img src="<?php echo e(get_file($setting['nepalste_image'] ?? Storage::url('uploads/payment/nepalste.png')) ?? asset(Storage::url('uploads/payment/nepalste.png'))); ?>"
                                                    class="img-center img-fluid p-1"
                                                    style="max-height: 100px;">
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="nepalste_unfo"
                                                        class="form-label"><?php echo e(__('Description')); ?></label>
                                                    <?php echo Form::textarea('nepalste_unfo', $setting['nepalste_unfo'] ?? '', [
                                                        'class' => 'autogrow form-control',
                                                        'placeholder' => __('Enter Description'),
                                                        'rows' => '5',
                                                        'id' => 'nepalste_unfo',
                            ...
                            <div id="collapseone_payhere" class="accordion-collapse collapse"
                                ...
                                <div class="accordion-body">
                                    <div class="row mt-2">
                                        ...
                                        <div class="col-md-6 text-end">
                                            <?php echo Form::hidden('is_payhere_enabled', 'off'); ?>
                                                        ...
                                                        <div class="form-check">
                                                            <label class="form-check-labe text-dark">
                                                                <input type="radio"
                                                                    ...
                                                                    class="form-check-input"
                                                                    checked="checked"
                                                                    <?php echo e((isset($setting['payhere_mode']) && $setting['payhere_mode'] == '') || (isset($setting['payhere_mode']) && $setting['payhere_mode'] == 'sandbox') ? 'checked="checked"' : ''); ?>>
                                                                <?php echo e(__('Sandbox')); ?>
                                                        ...
                                                        <div class="form-check">
                                                            <label class="form-check-labe text-dark">
                                                                <input type="radio"
                                                                    ...
                                                                    class="form-check-input"
                                                                    <?php echo e(isset($setting['payhere_mode']) && $setting['payhere_mode'] == 'live' ? 'checked="checked"' : ''); ?>>
                                                                <?php echo e(__('Live')); ?>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control"
                                                    ...
                                                    value="<?php echo e($setting['payhere_merchant_id'] ?? ''); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control"
                                                    placeholder="<?php echo e(__('Enter Merchant Secret')); ?>"
                                                    name="payhere_merchant_secret" type="text"
                                                    value="<?php echo e($setting['payhere_merchant_secret'] ?? ''); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" placeholder="<?php echo e(__('Enter App ID')); ?>"
                                                    name="payhere_app_id" type="text"
                                                    value="<?php echo e($setting['payhere_app_id'] ?? ''); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control"
                                                    placeholder="<?php echo e(__('Enter App Secret Key')); ?>"
                                                    name="payhere_app_secret" type="text"
                                                    value="<?php echo e($setting['payhere_app_secret'] ?? ''); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <img src="<?php echo e(get_file($setting['payhere_image'] ?? Storage::url('uploads/payment/payhere.png')) ?? asset(Storage::url('uploads/payment/payhere.png'))); ?>"
                                                    class="img-center img-fluid p-1"
                                                    style="max-height: 100px;">
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="payhere_unfo"
                                                        class="form-label"><?php echo e(__('Description')); ?></label>
                                                    <?php echo Form::textarea('payhere_unfo', $setting['payhere_unfo'] ?? '', [
                                                        'class' => 'autogrow form-control',
                                                        'placeholder' => __('Enter Description'),
                                                        'rows' => '5',
                                                        'id' => 'payhere_unfo',
                            ...
                            <div id="collapseone_khalti" class="accordion-collapse collapse"
                                ...
                                <div class="accordion-body">
                                    <div class="row mt-2">
                                        ...
                                        <div class="col-md-6 text-end">
                                            <?php echo Form::hidden('is_khalti_enabled', 'off'); ?>
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control"
                                                    ...
                                                    value="<?php echo e($setting['khalti_public_key'] ?? ''); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control"
                                                    ...
                                                    value="<?php echo e($setting['khalti_secret_key'] ?? ''); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <img src="<?php echo e(get_file($setting['khalti_image'] ?? Storage::url('uploads/payment/khalti.png')) ?? asset(Storage::url('uploads/payment/khalti.png'))); ?>"
                                                    class="img-center img-fluid p-1"
                                                    style="max-height: 100px;">
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="khalti_unfo"
                                                        class="form-label"><?php echo e(__('Description')); ?></label>
                                                    <?php echo Form::textarea('khalti_unfo', $setting['khalti_unfo'] ?? '', [
                                                        'class' => 'autogrow form-control',
                                                        'placeholder' => __('Enter Description'),
                                                        'rows' => '5',
                                                        'id' => 'khalti_unfo',
                        ...
                        <div class="accordion-item card">
                            <h2 class="accordion-header" id="authorizenet">
                                <button class="accordion-button" type="button"
                                    ...
                                    <span class="d-flex align-items-center">
                                        <i class="ti ti-credit-card me-2"></i>
                                        <?php echo e(__('AuthorizeNet')); ?></span>
                                </button>
                            </h2>
                            <div id="collapseone_authorizenet" class="accordion-collapse collapse"
                                ...
                                <div class="accordion-body">
                                    <div class="row mt-2">
                                        ...
                                        <div class="col-md-6 text-end">
                                            <?php echo Form::hidden('is_authorizenet_enabled', 'off'); ?>
                                                        ...
                                                        <div class="form-check">
                                                            <label class="form-check-labe text-dark">
                                                                <input type="radio"
                                                                    ...
                                                                    class="form-check-input"
                                                                    checked="checked"
                                                                    <?php echo e((isset($setting['authorizenet_mode']) && $setting['authorizenet_mode'] == '') || (isset($setting['authorizenet_mode']) && $setting['authorizenet_mode'] == 'sandbox') ? 'checked="checked"' : ''); ?>>
                                                                <?php echo e(__('Sandbox')); ?>
                                                        ...
                                                        <div class="form-check">
                                                            <label class="form-check-labe text-dark">
                                                                <input type="radio"
                                                                    ...
                                                                    value="production"
                                                                    class="form-check-input"
                                                                    <?php echo e(isset($setting['authorizenet_mode']) && $setting['authorizenet_mode'] == 'production' ? 'checked="checked"' : ''); ?>>
                                                                <?php echo e(__('Production')); ?>
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                <label for="authorizenet_login_id"
                                                    class="col-form-label"><?php echo e(__('Merchant Login ID')); ?></label>
                                                <input class="form-control"
                                                    placeholder="<?php echo e(__('Enter Merchant Login ID')); ?>"
                                                    name="authorizenet_login_id" type="text"
                                                    value="<?php echo e($setting['authorizenet_login_id'] ?? ''); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                <label for="authorizenet_transaction_key"
                                                    class="col-form-label"><?php echo e(__('Merchant Transaction Key')); ?></label>
                                                <input class="form-control"
                                                    placeholder="<?php echo e(__('Enter Merchant Transaction Key')); ?>"
                                                    name="authorizenet_transaction_key" type="text"
                                                    value="<?php echo e($setting['authorizenet_transaction_key'] ?? ''); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <img src="<?php echo e(get_file($setting['authorizenet_image'] ?? Storage::url('uploads/payment/authorizenet.png')) ?? asset(Storage::url('uploads/payment/authorizenet.png'))); ?>"
                                                    class="img-center img-fluid p-1"
                                                    style="max-height: 100px;">
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="authorizenet_unfo"
                                                        class="form-label"><?php echo e(__('Description')); ?></label>
                                                    <?php echo Form::textarea('authorizenet_unfo', $setting['authorizenet_unfo'] ?? '', [
                                                        'class' => 'autogrow form-control',
                                                        'placeholder' => __('Enter Description'),
                                                        'rows' => '5',
                            ...
                            <div id="collapseone_tap" class="accordion-collapse collapse"
                                ...
                                <div class="accordion-body">
                                    <div class="row mt-2">
                                        ...
                                        <div class="col-md-6 text-end">
                                            <?php echo Form::hidden('is_tap_enabled', 'off'); ?>
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                <label for="tap_secret_key"
                                                    class="col-form-label"><?php echo e(__('Secret Key')); ?></label>
                                                <input class="form-control"
                                                    placeholder="<?php echo e(__('Enter Secret Key')); ?>" name="tap_secret_key"
                                                    type="text"
                                                    value="<?php echo e($setting['tap_secret_key'] ?? ''); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <img src="<?php echo e(get_file($setting['tap_image'] ?? Storage::url('uploads/payment/tap.png')) ?? asset(Storage::url('uploads/payment/tap.png'))); ?>"
                                                    class="img-center img-fluid p-1"
                                                    style="max-height: 100px;">
                                            </div>
                                        </div>
                                        <?php if(\Auth::user()->type == 'admin'): ?>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="tap_unfo"
                                                        class="form-label"><?php echo e(__('Description')); ?></label>
                                                    <?php echo Form::textarea('tap_unfo', $setting['tap_unfo'] ?? '', [
                                                        'class' => 'autogrow form-control',
                                                        'placeholder' => __('Enter Description'),
                                                        'rows' => '5',
                                                        'id' => 'tap_unfo',
                            ...
                            <div id="collapseone_phonepe" class="accordion-collapse collapse"
                                ...
                                <div class="accordion-body">
                                    <div class="row mt-2">
                                        ...
                                        <div class="col-md-6 text-end">
                                            <?php echo Form::hidden('is_phonepe_enabled', 'off'); ?>
                                        ...
                                        <div class="col-lg-12 pb-4">
                                            <label class="col-form-label"
                                                for="phonepe_mode"><?php echo e(__('PhonePe Mode')); ?></label>
                                            <br>
                                            <div class="d-flex flex-wrap gap-2">
                                                <div class="mr-2" >
                                                    <div class="border card p-3">
                                                        <div class="form-check">
                                                            <label class="form-check-labe text-dark">
                                                                <input type="radio"
                                                                    ...
                                                                    class="form-check-input"
                                                                    checked="checked"
                                                                    <?php echo e((isset($setting['phonepe_mode']) && $setting['phonepe_mode'] == '') || (isset($setting['phonepe_mode']) && $setting['phonepe_mode'] == 'sandbox') ? 'checked="checked"' : ''); ?>>
                                                                <?php echo e(__('Sandbox')); ?>
                                                        ...
                                                        <div class="form-check">
                                                            <label class="form-check-labe text-dark">
                                                                <input type="radio"
                                                                    ...
                                                                    value="production"
                                                                    class="form-check-input"
                                                                    <?php echo e(isset($setting['phonepe_mode']) && $setting['phonepe_mode'] == 'production' ? 'checked="checked"' : ''); ?>>
                                                                <?php echo e(__('Production')); ?>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control"
                                                    ...
                                                    value="<?php echo e($setting['phonepe_merchant_key'] ?? ''); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="phonepe_merchant_user_id"
                                                    class="col-form-label"><?php echo e(__('Merchant User ID')); ?></label>
                                                <input class="form-control"
                                                    placeholder="<?php echo e(__('Enter Merchant User ID')); ?>"
                                                    name="phonepe_merchant_user_id" type="text"
                                                    value="<?php echo e($setting['phonepe_merchant_user_id'] ?? ''); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                <label for="ayment"
                                                    class="col-form-label"><?php echo e(__('Salt Key')); ?></label>
                                                <input class="form-control" placeholder="<?php echo e(__('Enter Salt Key')); ?>"
                                                    name="phonepe_salt_key" type="text"
                                                    value="<?php echo e($setting['phonepe_salt_key'] ?? ''); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <img src="<?php echo e(get_file($setting['phonepe_image'] ?? Storage::url('uploads/payment/phonepe.png')) ?? asset(Storage::url('uploads/payment/phonepe.png'))); ?>"
                                                    class="img-center img-fluid p-1"
                                                    style="max-height: 100px;">
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="phonepe_unfo"
                                                        class="form-label"><?php echo e(__('Description')); ?></label>
                                                    <?php echo Form::textarea('phonepe_unfo', $setting['phonepe_unfo'] ?? '', [
                                                        'class' => 'autogrow form-control',
                                                        'placeholder' => __('Enter Description'),
                                                        'rows' => '5',
                                                        'id' => 'phonepe_unfo',
                            ...
                            <div id="collapseone_paddle" class="accordion-collapse collapse"
                                ...
                                <div class="accordion-body">
                                    <div class="row mt-2">
                                        ...
                                        <div class="col-md-6 text-end">
                                            <?php echo Form::hidden('is_paddle_enabled', 'off'); ?>
                                        ...
                                        <div class="col-lg-12 pb-4">
                                            <label class="col-form-label"
                                                for="paddle_mode"><?php echo e(__('Paddle Mode')); ?></label>
                                            <br>
                                            <div class="d-flex flex-wrap gap-2">
                                                <div class="mr-2" >
                                                    <div class="border card p-3">
                                                        <div class="form-check">
                                                            <label class="form-check-labe text-dark">
                                                                <input type="radio" name="paddle_mode"
                                                                    ...
                                                                    class="form-check-input"
                                                                    checked="checked"
                                                                    <?php echo e((isset($setting['paddle_mode']) && $setting['paddle_mode'] == '') || (isset($setting['paddle_mode']) && $setting['paddle_mode'] == 'sandbox') ? 'checked="checked"' : ''); ?>>
                                                                <?php echo e(__('Sandbox')); ?>
                                                        ...
                                                        <div class="form-check">
                                                            <label class="form-check-labe text-dark">
                                                                <input type="radio" name="paddle_mode"
                                                                    value="live"
                                                                    class="form-check-input"
                                                                    <?php echo e(isset($setting['paddle_mode']) && $setting['paddle_mode'] == 'live' ? 'checked="checked"' : ''); ?>>
                                                                <?php echo e(__('Live')); ?>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="paddle_vendor_id"
                                                    class="col-form-label"><?php echo e(__('Vendor ID')); ?></label>
                                                <input class="form-control"
                                                    placeholder="<?php echo e(__('Enter Vendor ID')); ?>"
                                                    name="paddle_vendor_id" type="text"
                                                    value="<?php echo e($setting['paddle_vendor_id'] ?? ''); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="paddle_vendor_auth_code"
                                                    class="col-form-label"><?php echo e(__('Vendor Auth Code')); ?></label>
                                                <input class="form-control"
                                                    placeholder="<?php echo e(__('Enter Vendor Auth Code')); ?>"
                                                    name="paddle_vendor_auth_code" type="text"
                                                    value="<?php echo e($setting['paddle_vendor_auth_code'] ?? ''); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control"
                                                    ...
                                                    value="<?php echo e($setting['paddle_public_key'] ?? ''); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <img src="<?php echo e(get_file($setting['paddle_image'] ?? Storage::url('uploads/payment/paddle.png')) ?? asset(Storage::url('uploads/payment/paddle.png'))); ?>"
                                                    class="img-center img-fluid p-1"
                                                    style="max-height: 100px;">
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="paddle_unfo"
                                                        class="form-label"><?php echo e(__('Description')); ?></label>
                                                    <?php echo Form::textarea('paddle_unfo', $setting['paddle_unfo'] ?? '', [
                                                        'class' => 'autogrow form-control',
                                                        'placeholder' => __('Enter Description'),
                                                        'rows' => '5',
                                                        'id' => 'paddle_unfo',
                        ...
                        <div class="accordion-item card">
                            <h2 class="accordion-header" id="paiementpro">
                                <button class="accordion-button" type="button"
                                    ...
                                    <span class="d-flex align-items-center">
                                        <i class="ti ti-credit-card me-2"></i>
                                        <?php echo e(__('Paiement Pro')); ?></span>
                                </button>
                            </h2>
                            <div id="collapseone_paiementpro" class="accordion-collapse collapse"
                                ...
                                <div class="accordion-body">
                                    <div class="row mt-2">
                                        ...
                                        <div class="col-md-6 text-end">
                                            <?php echo Form::hidden('is_paiementpro_enabled', 'off'); ?>
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control"
                                                    ...
                                                    value="<?php echo e($setting['paiementpro_merchant_id'] ?? ''); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <img src="<?php echo e(get_file($setting['paiementpro_image'] ?? Storage::url('uploads/payment/paiementpro.png')) ?? asset(Storage::url('uploads/payment/paiementpro.png'))); ?>"
                                                    class="img-center img-fluid p-1"
                                                    style="max-height: 100px;">
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="paiementpro_unfo"
                                                        class="form-label"><?php echo e(__('Description')); ?></label>
                                                    <?php echo Form::textarea('paiementpro_unfo', $setting['paiementpro_unfo'] ?? '', [
                                                        'class' => 'autogrow form-control',
                                                        'placeholder' => __('Enter Description'),
                                                        'rows' => '5',
                                                        'id' => 'paiementpro_unfo',
                            ...
                            <div id="collapseone_fedpay" class="accordion-collapse collapse"
                                ...
                                <div class="accordion-body">
                                    <div class="row mt-2">
                                        ...
                                        <div class="col-md-6 text-end">
                                            <?php echo Form::hidden('is_fedpay_enabled', 'off'); ?>
                                        ...
                                        <div class="col-lg-12 pb-4">
                                            <label class="col-form-label"
                                                for="fedpay_mode"><?php echo e(__('FedaPay Mode')); ?></label>
                                            <br>
                                            <div class="d-flex flex-wrap gap-2">
                                                <div class="mr-2" >
                                                    <div class="border card p-3">
                                                        <div class="form-check">
                                                            <label class="form-check-labe text-dark">
                                                                <input type="radio" name="fedpay_mode"
                                                                    ...
                                                                    class="form-check-input"
                                                                    checked="checked"
                                                                    <?php echo e((isset($setting['fedpay_mode']) && $setting['fedpay_mode'] == '') || (isset($setting['fedpay_mode']) && $setting['fedpay_mode'] == 'sandbox') ? 'checked="checked"' : ''); ?>>
                                                                <?php echo e(__('Sandbox')); ?>
                                                        ...
                                                        <div class="form-check">
                                                            <label class="form-check-labe text-dark">
                                                                <input type="radio" name="fedpay_mode"
                                                                    value="live"
                                                                    class="form-check-input"
                                                                    <?php echo e(isset($setting['fedpay_mode']) && $setting['fedpay_mode'] == 'live' ? 'checked="checked"' : ''); ?>>
                                                                <?php echo e(__('Live')); ?>
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control"
                                                    ...
                                                    value="<?php echo e($setting['fedpay_public_key'] ?? ''); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control"
                                                    ...
                                                    value="<?php echo e($setting['fedpay_secret_key'] ?? ''); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <?php echo Form::label('fedpay_image', __('Image'), ['class' => 'form-label']); ?>
                                                ...
                                                <img src="<?php echo e(get_file($setting['fedpay_image'] ?? Storage::url('uploads/payment/fedpay.png')) ?? asset(Storage::url('uploads/payment/fedpay.png'))); ?>"
                                                    class="img-center img-fluid p-1"
                                                    style="max-height: 100px;">
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="fedpay_unfo"
                                                        class="form-label"><?php echo e(__('Description')); ?></label>
                                                    <?php echo Form::textarea('fedpay_unfo', $setting['fedpay_unfo'] ?? '', [
                                                        'class' => 'autogrow form-control',
                                                        'placeholder' => __('Enter Description'),
                                                        'rows' => '5',
                                                        'id' => 'fedpay_unfo',
                                    ...
                                    <div class="row mt-2">
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control"
                                                    placeholder="<?php echo e(__('Enter CinetPay Site ID')); ?>"
                                                    name="cinet_pay_site_id" type="text"
                                                    value="<?php echo e($setting['cinet_pay_site_id'] ?? ''); ?>">
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control"
                                                    placeholder="<?php echo e(__('Enter CinetPay Api Key')); ?>"
                                                    name="cinet_pay_api_key" type="text"
                                                    value="<?php echo e($setting['cinet_pay_api_key'] ?? ''); ?>">
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control"
                                                    placeholder="<?php echo e(__('Enter CinetPay Secret Key')); ?>"
                                                    name="cinet_pay_secret_key" type="text"
                                                    value="<?php echo e($setting['cinet_pay_secret_key'] ?? ''); ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <img alt="Image placeholder"
                                                    src="<?php echo e(get_file($setting['cinet_pay_image'] ?? Storage::url('uploads/payment/cinet.png')) ?? asset(Storage::url('uploads/payment/cinet.png'))); ?>"
                                                    class="img-center img-fluid p-1"
                                                    style="max-height: 100px;">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="stripe_unfo"
                                                    class="form-label"><?php echo e(__('Description')); ?></label>
                                                <?php echo Form::textarea('cinet_pay_unfo', $setting['cinet_pay_unfo'] ?? '', [
                                                    'class' => 'autogrow form-control',
                                                    'placeholder' => __('Enter Description'),
                                                    'rows' => '5',
                                                    'id' => 'cinet_pay_unfo',
                            ...
                            <div id="collapseone_Senangpay" class="accordion-collapse collapse"
                                ...
                                <div class="accordion-body">
                                    <div class="row mt-2">
                                        ...
                                        <div class="col-lg-12 pb-4">
                                            <label class="col-form-label"
                                                for="Senangpay_mode"><?php echo e(__('SenangPay Mode')); ?></label>
                                            <br>
                                            <div class="d-flex flex-wrap gap-2">
                                                <div class="mr-2" >
                                                    <div class="border card p-3">
                                                        <div class="form-check">
                                                            <label class="form-check-labe text-dark">
                                                                <input type="radio"
                                                                    ...
                                                                    class="form-check-input"
                                                                    checked="checked"
                                                                    <?php echo e((isset($setting['Senangpay_mode']) && $setting['Senangpay_mode'] == '') || (isset($setting['Senangpay_mode']) && $setting['Senangpay_mode'] == 'sandbox') ? 'checked="checked"' : ''); ?>>
                                                                <?php echo e(__('Sandbox')); ?>
                                                        ...
                                                        <div class="form-check">
                                                            <label class="form-check-labe text-dark">
                                                                <input type="radio"
                                                                    ...
                                                                    class="form-check-input"
                                                                    <?php echo e(isset($setting['Senangpay_mode']) && $setting['Senangpay_mode'] == 'live' ? 'checked="checked"' : ''); ?>>
                                                                <?php echo e(__('Live')); ?>
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                <label for="Senangpay_merchant_id"
                                                    class="form-label"><?php echo e(__('SenangPay Merchant ID')); ?></label>
                                                <input class="form-control"
                                                    placeholder="<?php echo e(__('Enter SenangPay Merchant ID')); ?>"
                                                    name="senang_pay_merchant_id" type="text"
                                                    value="<?php echo e($setting['senang_pay_merchant_id'] ?? ''); ?>">
                                            </div>

                                            <div class="form-group">
                                                <label for="senang_pay_secret_key"
                                                    class="form-label"><?php echo e(__('SenangPay Secret Key')); ?></label>
                                                <input class="form-control"
                                                    placeholder="<?php echo e(__('Enter SenangPay Secret Key')); ?>"
                                                    name="senang_pay_secret_key" type="text"
                                                    value="<?php echo e($setting['senang_pay_secret_key'] ?? ''); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <img alt="Image placeholder"
                                                    src="<?php echo e(get_file($setting['senang_pay_image'] ?? Storage::url('uploads/payment/senang.png')) ?? asset(Storage::url('uploads/payment/senang.png'))); ?>"
                                                    class="img-center img-fluid p-1"
                                                    style="max-height: 100px;">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="senang_unfo"
                                                    class="form-label"><?php echo e(__('Description')); ?></label>
                                                <?php echo Form::textarea('senang_pay_unfo', $setting['senang_pay_unfo'] ?? '', [
                                                    'class' => 'autogrow form-control',
                                                    'rows' => '5',
                                                    'placeholder' => __('Enter Description'),
                                                    'id' => 'senang_pay_unfo',
                        ...
                        <div class="accordion-item card">
                            <h2 class="accordion-header" id="cybersource">
                                <button class="accordion-button" type="button"
                                    ...
                                    <span class="d-flex align-items-center">
                                        <i class="ti ti-credit-card me-2"></i>
                                        <?php echo e(__('CyberSource')); ?></span>
                                </button>
                            </h2>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="cybersource_pay_merchant_id"
                                                    class="form-label"><?php echo e(__('CyberSource Merchant ID')); ?></label>
                                                <input class="form-control"
                                                    placeholder="<?php echo e(__('Enter CyberSource Merchant ID')); ?>"
                                                    name="cybersource_pay_merchant_id" type="text"
                                                    value="<?php echo e($setting['cybersource_pay_merchant_id'] ?? ''); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="cybersource_pay_secret_key"
                                                    class="form-label"><?php echo e(__('CyberSource Secret Key')); ?></label>
                                                <input class="form-control"
                                                    placeholder="<?php echo e(__('Enter CyberSource Secret Key')); ?>"
                                                    name="cybersource_pay_secret_key" type="text"
                                                    value="<?php echo e($setting['cybersource_pay_secret_key'] ?? ''); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                <label for="cybersource_pay_api_key"
                                                    class="form-label"><?php echo e(__('CyberSource Api Key')); ?></label>
                                                <input class="form-control"
                                                    placeholder="<?php echo e(__('Enter CyberSource Api Key')); ?>"
                                                    name="cybersource_pay_api_key" type="text"
                                                    value="<?php echo e($setting['cybersource_pay_api_key'] ?? ''); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <img alt="Image placeholder"
                                                    src="<?php echo e(get_file($setting['cybersource_pay_image'] ?? Storage::url('uploads/payment/cybersource.png')) ?? asset(Storage::url('uploads/payment/cybersource.png'))); ?>"
                                                    class="img-center img-fluid p-1"
                                                    style="max-height: 100px;">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="cybersource_pay_unfo"
                                                    class="form-label"><?php echo e(__('Description')); ?></label>
                                                <?php echo Form::textarea('cybersource_pay_unfo', $setting['cybersource_pay_unfo'] ?? '', [
                                                    'class' => 'autogrow form-control',
                                                    'placeholder' => __('Enter Description'),
                                                    'rows' => '5',
                                    ...
                                    <div class="row mt-2">
                                                        ...
                                                        <div class="form-check">
                                                            <label class="form-check-labe text-dark">
                                                                <input type="radio" name="ozow_mode"
                                                                    ...
                                                                    class="form-check-input"
                                                                    checked="checked"
                                                                    <?php echo e((isset($setting['ozow_mode']) && $setting['ozow_mode'] == '') || (isset($setting['ozow_mode']) && $setting['ozow_mode'] == 'sandbox') ? 'checked="checked"' : ''); ?>>
                                                                <?php echo e(__('Sandbox')); ?>
                                                        ...
                                                        <div class="form-check">
                                                            <label class="form-check-labe text-dark">
                                                                <input type="radio" name="ozow_mode"
                                                                    value="live"
                                                                    class="form-check-input"
                                                                    <?php echo e(isset($setting['ozow_mode']) && $setting['ozow_mode'] == 'live' ? 'checked="checked"' : ''); ?>>
                                                                <?php echo e(__('Live')); ?>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" placeholder="<?php echo e(__('Enter Ozow Site Key')); ?>"
                                                    name="ozow_pay_Site_key" type="text"
                                                    value="<?php echo e($setting['ozow_pay_Site_key'] ?? ''); ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control"
                                                    placeholder="<?php echo e(__('Enter Ozow Private Key')); ?>"
                                                    name="ozow_pay_private_key" type="text"
                                                    value="<?php echo e($setting['ozow_pay_private_key'] ?? ''); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" placeholder="<?php echo e(__('Enter Ozow Api Key')); ?>"
                                                    name="ozow_pay_api_key" type="text"
                                                    value="<?php echo e($setting['ozow_pay_api_key'] ?? ''); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <img alt="Image placeholder"
                                                    src="<?php echo e(get_file($setting['ozow_pay_image'] ?? Storage::url('uploads/payment/ozow.png')) ?? asset(Storage::url('uploads/payment/ozow.png'))); ?>"
                                                    class="img-center img-fluid p-1"
                                                    style="max-height: 100px;">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="ozow_unfo"
                                                    class="form-label"><?php echo e(__('Description')); ?></label>
                                                <?php echo Form::textarea('ozow_pay_unfo', $setting['ozow_pay_unfo'] ?? '', [
                                                    'class' => 'autogrow form-control',
                                                    'placeholder' => __('Enter Description'),
                                                    'rows' => '5',
                                                    'id' => 'ozow_pay_unfo',
                            ...
                            <div id="collapseone_myfatoorah" class="accordion-collapse collapse"
                                ...
                                <div class="accordion-body">
                                    <div class="row mt-2">
                                        ...
                                        <div class="col-lg-12 pb-4">
                                            <label class="col-form-label"
                                                for="myfatoorah_mode"><?php echo e(__('MyFatoorah Mode')); ?></label>
                                            <br>
                                            <div class="d-flex flex-wrap gap-2">
                                                <div class="mr-2" >
                                                    <div class="border card p-3">
                                                        <div class="form-check">
                                                            <label class="form-check-labe text-dark">
                                                                <input type="radio"
                                                                    ...
                                                                    class="form-check-input"
                                                                    checked="checked"
                                                                    <?php echo e((isset($setting['myfatoorah_mode']) && $setting['myfatoorah_mode'] == '') || (isset($setting['myfatoorah_mode']) && $setting['myfatoorah_mode'] == 'sandbox') ? 'checked="checked"' : ''); ?>>
                                                                <?php echo e(__('Sandbox')); ?>
                                                        ...
                                                        <div class="form-check">
                                                            <label class="form-check-labe text-dark">
                                                                <input type="radio"
                                                                    ...
                                                                    value="live"
                                                                    class="form-check-input"
                                                                    <?php echo e(isset($setting['myfatoorah_mode']) && $setting['myfatoorah_mode'] == 'live' ? 'checked="checked"' : ''); ?>>
                                                                <?php echo e(__('Live')); ?>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="myfatoorah_pay_api_key"
                                                    class="form-label"><?php echo e(__('MyFatoorah Api Key')); ?></label>
                                                <input class="form-control"
                                                    placeholder="<?php echo e(__('Enter MyFatoorah Api Key')); ?>"
                                                    name="myfatoorah_pay_api_key" type="text"
                                                    value="<?php echo e($setting['myfatoorah_pay_api_key'] ?? ''); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="myfatoorah_pay_country_iso"
                                                    class="form-label"><?php echo e(__('MyFatoorah Country ISO')); ?></label>
                                                <input class="form-control"
                                                    placeholder="<?php echo e(__('Enter MyFatoorah Country ISO')); ?>"
                                                    name="myfatoorah_pay_country_iso" type="text"
                                                    value="<?php echo e($setting['myfatoorah_pay_country_iso'] ?? ''); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <img alt="Image placeholder"
                                                    src="<?php echo e(get_file($setting['myfatoorah_pay_image'] ?? Storage::url('uploads/payment/myfatoorah.png')) ?? asset(Storage::url('uploads/payment/myfatoorah.png'))); ?>"
                                                    class="img-center img-fluid p-1"
                                                    style="max-height: 100px;">
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="myfatoorah_unfo"
                                                        class="form-label"><?php echo e(__('Description')); ?></label>
                                                    <?php echo Form::textarea('myfatoorah_pay_unfo', $setting['myfatoorah_pay_unfo'] ?? '', [
                                                        'class' => 'autogrow form-control',
                                                        'rows' => '5',
                                                        'placeholder' => __('Enter Description'),
                            ...
                            <div id="collapseone_easebuzz" class="accordion-collapse collapse"
                                ...
                                <div class="accordion-body">
                                    <div class="row mt-2">
                                        ...
                                        <div class="col-md-6 text-end">
                                            <?php echo Form::hidden('is_easebuzz_enabled', 'off'); ?>
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                <label for="easebuzz_merchant_key"
                                                    class="col-form-label"><?php echo e(__('Easebuzz Merchant Key')); ?></label>
                                                <input class="form-control"
                                                    placeholder="<?php echo e(__('Enter Easebuzz Merchant Key')); ?>"
                                                    name="easebuzz_merchant_key" type="text"
                                                    value="<?php echo e($setting['easebuzz_merchant_key'] ?? ''); ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="easebuzz_salt_key"
                                                    class="col-form-label"><?php echo e(__('Easebuzz Salt Key')); ?></label>
                                                <input class="form-control"
                                                    placeholder="<?php echo e(__('Enter Easebuzz Salt Key')); ?>"
                                                    name="easebuzz_salt_key" type="text"
                                                    value="<?php echo e($setting['easebuzz_salt_key'] ?? ''); ?>">
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <input class="form-control"
                                                    ...
                                                    value="<?php echo e($setting['easebuzz_enviroment_name'] ?? ''); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <img alt="Image placeholder"
                                                    src="<?php echo e(get_file($setting['easebuzz_image'] ?? Storage::url('uploads/payment/easebuzz.png')) ?? asset(Storage::url('uploads/payment/easebuzz.png'))); ?>"
                                                    class="img-center img-fluid p-1"
                                                    style="max-height: 100px;">
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="easebuzz_unfo"
                                                        class="form-label"><?php echo e(__('Description')); ?></label>
                                                    <?php echo Form::textarea('easebuzz_unfo', $setting['easebuzz_unfo'] ?? '', [
                                                        'class' => 'autogrow form-control',
                                                        'placeholder' => __('Enter Description'),
                                                        'rows' => '5',
                                                        'id' => 'easebuzz_unfo',
                            ...
                            <div id="collapseone_nmi" class="accordion-collapse collapse"
                                ...
                                <div class="accordion-body">
                                    <div class="row mt-2">
                                        ...
                                        <div class="col-md-6 text-end">
                                            <?php echo Form::hidden('is_nmi_enabled', 'off'); ?>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="nmi_api_private_key"
                                                        class="col-form-label"><?php echo e(__('NMI Api Private Key')); ?></label>
                                                    <input class="form-control"
                                                        placeholder="<?php echo e(__('Enter NMI Api Private Key')); ?>"
                                                        name="nmi_api_private_key" type="text"
                                                        value="<?php echo e($setting['nmi_api_private_key'] ?? ''); ?>">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <img alt="Image placeholder"
                                                        src="<?php echo e(get_file($setting['nmi_image'] ?? Storage::url('uploads/payment/nmi.png')) ?? asset(Storage::url('uploads/payment/nmi.png'))); ?>"
                                                        class="img-center img-fluid p-1"
                                                        style="max-height: 100px;">
                                                </div>
                                            </div>
                                        ...
                                        <?php if(\Auth::user()->type == 'admin'): ?>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="nmi_unfo"
                                                        class="form-label"><?php echo e(__('Description')); ?></label>
                                                    <?php echo Form::textarea('nmi_unfo', $setting['nmi_unfo'] ?? '', [
                                                        'class' => 'autogrow form-control',
                                                        'placeholder' => __('Enter Description'),
                                                        'rows' => '5',
                                                        'id' => 'nmi_unfo',
                            ...
                            <div id="collapseone_payu" class="accordion-collapse collapse"
                                ...
                                <div class="accordion-body">
                                    <div class="row mt-2">
                                        ...
                                        <div class="col-lg-12 pb-4">
                                            <label class="col-form-label"
                                                for="payu_mode"><?php echo e(__('PayU Mode')); ?></label>
                                            <br>
                                            <div class="d-flex flex-wrap gap-2">
                                                <div class="mr-2" >
                                                    <div class="border card p-3">
                                                        <div class="form-check">
                                                            <label class="form-check-labe text-dark">
                                                                <input type="radio" name="payu_mode"
                                                                    ...
                                                                    class="form-check-input"
                                                                    checked="checked"
                                                                    <?php echo e((isset($setting['payu_mode']) && $setting['payu_mode'] == '') || (isset($setting['payu_mode']) && $setting['payu_mode'] == 'sandbox') ? 'checked="checked"' : ''); ?>>
                                                                <?php echo e(__('Sandbox')); ?>
                                                        ...
                                                        <div class="form-check">
                                                            <label class="form-check-labe text-dark">
                                                                <input type="radio" name="payu_mode"
                                                                    value="production"
                                                                    class="form-check-input"
                                                                    <?php echo e(isset($setting['payu_mode']) && $setting['payu_mode'] == 'production' ? 'checked="checked"' : ''); ?>>
                                                                <?php echo e(__('Production')); ?>
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" placeholder="<?php echo e(__('Enter Merchant Key')); ?>"
                                                    ...
                                                    value="<?php echo e($setting['payu_merchant_key'] ?? ''); ?>">
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" placeholder="<?php echo e(__('Enter Salt Key')); ?>"
                                                    ...
                                                    value="<?php echo e($setting['payu_salt_key'] ?? ''); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <img alt="Image placeholder"
                                                    src="<?php echo e(get_file($setting['payu_image'] ?? Storage::url('uploads/payment/payu.png')) ?? asset(Storage::url('uploads/payment/payu.png'))); ?>"
                                                    class="img-center img-fluid p-1"
                                                    style="max-height: 100px;">
                                            </div>
                                        </div>
                                        <?php if(\Auth::user()->type == 'admin'): ?>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="payu_unfo"
                                                        class="form-label"><?php echo e(__('Description')); ?></label>
                                                    <?php echo Form::textarea('payu_unfo', $setting['payu_unfo'] ?? '', [
                                                        'class' => 'autogrow form-control',
                                                        'placeholder' => __('Enter Description'),
                                                        'rows' => '5',
                                                        'id' => 'payu_unfo',
                            ...
                            <div id="collapseone_paynow" class="accordion-collapse collapse"
                                ...
                                <div class="accordion-body">
                                    <div class="row mt-2">
                                        ...
                                        <div class="col-lg-12 pb-4">
                                            <label class="col-form-label"
                                                for="paynow_mode"><?php echo e(__('Paynow Mode')); ?></label>
                                            <br>
                                            <div class="d-flex flex-wrap gap-2">
                                                <div class="mr-2" >
                                                    <div class="border card p-3">
                                                        <div class="form-check">
                                                            <label class="form-check-labe text-dark">
                                                                <input type="radio" name="paynow_mode"
                                                                    ...
                                                                    class="form-check-input"
                                                                    checked="checked"
                                                                    <?php echo e((isset($setting['paynow_mode']) && $setting['paynow_mode'] == '') || (isset($setting['paynow_mode']) && $setting['paynow_mode'] == 'sandbox') ? 'checked="checked"' : ''); ?>>
                                                                <?php echo e(__('Sandbox')); ?>
                                                        ...
                                                        <div class="form-check">
                                                            <label class="form-check-labe text-dark">
                                                                <input type="radio" name="paynow_mode"
                                                                    value="production"
                                                                    class="form-check-input"
                                                                    <?php echo e(isset($setting['paynow_mode']) && $setting['paynow_mode'] == 'production' ? 'checked="checked"' : ''); ?>>
                                                                <?php echo e(__('Production')); ?>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="paynow_pay_integration_id"
                                                    class="form-label"><?php echo e(__('Paynow Integration ID')); ?></label>
                                                <input class="form-control"
                                                    placeholder="<?php echo e(__('Enter PayNow Integration ID')); ?>"
                                                    name="paynow_pay_integration_id" type="text"
                                                    value="<?php echo e($setting['paynow_pay_integration_id'] ?? ''); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="paynow_pay_integration_key"
                                                    class="form-label"><?php echo e(__('Paynow Integration Key')); ?></label>
                                                <input class="form-control"
                                                    placeholder="<?php echo e(__('Enter PayNow Integration Key')); ?>"
                                                    name="paynow_pay_integration_key" type="text"
                                                    value="<?php echo e($setting['paynow_pay_integration_key'] ?? ''); ?>">
                                            </div>
                                        </div>
                                        <div id="paynow_pay_merchant_email" class="col-md-6"
                                            ...
                                            <div class="form-group">
                                                <label for="paynow_pay_merchant_email"
                                                    class="form-label"><?php echo e(__('Paynow Merchant Email')); ?></label>
                                                <input class="form-control"
                                                    placeholder="<?php echo e(__('Enter Paynow Merchant Email')); ?>"
                                                    name="paynow_pay_merchant_email" type="text"
                                                    value="<?php echo e($setting['paynow_pay_merchant_email'] ?? ''); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <img alt="Image placeholder"
                                                    src="<?php echo e(get_file($setting['paynow_pay_image'] ?? Storage::url('uploads/payment/paynow.png')) ?? asset(Storage::url('uploads/payment/paynow.png'))); ?>"
                                                    class="img-center img-fluid p-1"
                                                    style="max-height: 100px;">
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="paynow_pay_unfo"
                                                        class="form-label"><?php echo e(__('Description')); ?></label>
                                                    <?php echo Form::textarea('paynow_pay_unfo', $setting['paynow_pay_unfo'] ?? '', [
                                                        'class' => 'autogrow form-control',
                                                        'rows' => '5',
                                                        'placeholder' => __('Enter Description'),
                                                        'id' => 'paynow_pay_unfo',
                                    ...
                                    <div class="row mt-2">
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                <label for="sofort_key"
                                                    class="form-label"><?php echo e(__('Sofort Publishable Key')); ?></label>
                                                <input class="form-control"
                                                    placeholder="<?php echo e(__('Enter Sofort Publishable Key')); ?>"
                                                    name="sofort_publishable_key" type="text"
                                                    value="<?php echo e($setting['sofort_publishable_key'] ?? ''); ?>">
                                            </div>

                                            <div class="form-group">
                                                <label for="sofort_secret"
                                                    class="form-label"><?php echo e(__('Sofort Secret Key')); ?></label>
                                                <input class="form-control" placeholder="<?php echo e(__('Enter Sofort Secret Key')); ?>"
                                                    name="sofort_secret_key" type="text"
                                                    value="<?php echo e($setting['sofort_secret_key'] ?? ''); ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <img alt="Image placeholder"
                                                    src="<?php echo e(get_file($setting['sofort_image'] ?? Storage::url('uploads/payment/sofort.png')) ?? asset(Storage::url('uploads/payment/sofort.png'))); ?>"
                                                    class="img-center img-fluid p-1"
                                                    style="max-height: 100px;">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="sofort_unfo"
                                                    class="form-label"><?php echo e(__('Description')); ?></label>
                                                <?php echo Form::textarea('sofort_unfo', $setting['sofort_unfo'] ?? '', [
                                                    'class' => 'autogrow form-control',
                                                    'rows' => '5',
                                                    'placeholder' => __('Enter Description'),
                                                    'id' => 'sofort_unfo',
                            ...
                            <div id="collapseone_esewa" class="accordion-collapse collapse"
                                ...
                                <div class="accordion-body">
                                    <div class="row mt-2">
                                        ...
                                        <div class="col-lg-12 pb-4">
                                            <label class="col-form-label"
                                                for="esewa_mode"><?php echo e(__('ESewa Mode')); ?></label>
                                            <br>
                                            <div class="d-flex flex-wrap gap-2">
                                                <div class="mr-2" >
                                                    <div class="border card p-3">
                                                        <div class="form-check">
                                                            <label class="form-check-labe text-dark">
                                                                <input type="radio" name="esewa_mode"
                                                                    ...
                                                                    class="form-check-input"
                                                                    checked="checked"
                                                                    <?php echo e((isset($setting['esewa_mode']) && $setting['esewa_mode'] == '') || (isset($setting['esewa_mode']) && $setting['esewa_mode'] == 'sandbox') ? 'checked="checked"' : ''); ?>>
                                                                <?php echo e(__('Sandbox')); ?>
                                                        ...
                                                        <div class="form-check">
                                                            <label class="form-check-labe text-dark">
                                                                <input type="radio" name="esewa_mode"
                                                                    value="live"
                                                                    class="form-check-input"
                                                                    <?php echo e(isset($setting['esewa_mode']) && $setting['esewa_mode'] == 'live' ? 'checked="checked"' : ''); ?>>
                                                                <?php echo e(__('Live')); ?>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label for="esewa_merchant_key"
                                                    class="col-form-label pt-0"><?php echo e(__('ESewa Merchant ID')); ?></label>
                                                <input type="text" name="esewa_merchant_key"
                                                    id="esewa_merchant_key" class="form-control"
                                                    value="<?php echo e($setting['esewa_merchant_key'] ?? ''); ?>"
                                                    placeholder="<?php echo e(__('Enter Esewa Access Token')); ?>" />
                                                <?php if($errors->has('esewa_merchant_key')): ?>
                                                    <span class="invalid-feedback d-block">
                                                        <?php echo e($errors->first('esewa_merchant_key')); ?>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <img alt="Image placeholder"
                                                    src="<?php echo e(get_file($setting['esewa_image'] ?? Storage::url('uploads/payment/esewa.png')) ?? asset(Storage::url('uploads/payment/esewa.png'))); ?>"
                                                    class="img-center img-fluid p-1"
                                                    style="max-height: 100px;">
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="esewa_unfo"
                                                        class="form-label"><?php echo e(__('Description')); ?></label>
                                                    <?php echo Form::textarea('esewa_unfo', $setting['esewa_unfo'] ?? '', [
                                                        'class' => 'autogrow form-control',
                                                        'rows' => '5',
                                                        'placeholder' => __('Enter Description'),
                                                        'id' => 'esewa_unfo',
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="dpo_pay_Company_Token"
                                                    class="form-label"><?php echo e(__('Company Token')); ?></label>
                                                <input class="form-control"
                                                    placeholder="<?php echo e(__('Enter DPO Company Token')); ?>"
                                                    name="dpo_pay_Company_Token" type="text"
                                                    value="<?php echo e($setting['dpo_pay_Company_Token'] ?? ''); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="dpo_pay_Service_Type"
                                                    class="form-label"><?php echo e(__('Service Type')); ?></label>
                                                <input class="form-control"
                                                    placeholder="<?php echo e(__('Enter DPO Service Type')); ?>"
                                                    name="dpo_pay_Service_Type" type="text"
                                                    value="<?php echo e($setting['dpo_pay_Service_Type'] ?? ''); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <img alt="Image placeholder"
                                                    src="<?php echo e(get_file($setting['dpo_pay_image'] ?? Storage::url('uploads/payment/dpo.png')) ?? asset(Storage::url('uploads/payment/dpo.png'))); ?>"
                                                    class="img-center img-fluid p-1"
                                                    style="max-height: 100px;">
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="dpo_pay_unfo"
                                                        class="form-label"><?php echo e(__('Description')); ?></label>
                                                    <?php echo Form::textarea('dpo_pay_unfo', $setting['dpo_pay_unfo'] ?? '', [
                                                        'class' => 'autogrow form-control',
                                                        'rows' => '5',
                                                        'placeholder' => __('Enter Description'),
                                                        'id' => 'dpo_pay_unfo',
                            ...
                            <div id="collapseone_braintree" class="accordion-collapse collapse"
                                ...
                                <div class="accordion-body">
                                    <div class="row mt-2">
                                        ...
                                        <div class="col-lg-12 pb-4">
                                            <label class="col-form-label"
                                                for="braintree_mode"><?php echo e(__('Braintree Mode')); ?></label>
                                            <br>
                                            <div class="d-flex flex-wrap gap-2">
                                                <div class="mr-2" >
                                                    <div class="border card p-3">
                                                        <div class="form-check">
                                                            <label class="form-check-labe text-dark">
                                                                <input type="radio"
                                                                    ...
                                                                    class="form-check-input"
                                                                    checked="checked"
                                                                    <?php echo e((isset($setting['braintree_mode']) && $setting['braintree_mode'] == '') || (isset($setting['braintree_mode']) && $setting['braintree_mode'] == 'sandbox') ? 'checked="checked"' : ''); ?>>
                                                                <?php echo e(__('Sandbox')); ?>
                                                        ...
                                                        <div class="form-check">
                                                            <label class="form-check-labe text-dark">
                                                                <input type="radio"
                                                                    ...
                                                                    class="form-check-input"
                                                                    <?php echo e(isset($setting['braintree_mode']) && $setting['braintree_mode'] == 'production' ? 'checked="checked"' : ''); ?>>
                                                                <?php echo e(__('Production')); ?>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="braintree_pay_merchant_id"
                                                    class="form-label"><?php echo e(__('Braintree Merchant ID')); ?></label>
                                                <input class="form-control"
                                                    placeholder="<?php echo e(__('Enter Braintree Merchant ID')); ?>"
                                                    name="braintree_pay_merchant_id" type="text"
                                                    value="<?php echo e($setting['braintree_pay_merchant_id'] ?? ''); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="braintree_pay_public_key"
                                                    class="form-label"><?php echo e(__('Braintree Public Key')); ?></label>
                                                <input class="form-control"
                                                    placeholder="<?php echo e(__('Enter Braintree Public Key')); ?>"
                                                    name="braintree_pay_public_key" type="text"
                                                    value="<?php echo e($setting['braintree_pay_public_key'] ?? ''); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                <label for="braintree_pay_private_key"
                                                    class="form-label"><?php echo e(__('Braintree Private Key')); ?></label>
                                                <input class="form-control"
                                                    placeholder="<?php echo e(__('Enter Braintree Private Key')); ?>"
                                                    name="braintree_pay_private_key" type="text"
                                                    value="<?php echo e($setting['braintree_pay_private_key'] ?? ''); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <img alt="Image placeholder"
                                                src="<?php echo e(get_file($setting['braintree_pay_image'] ?? Storage::url('uploads/payment/braintree.png')) ?? asset(Storage::url('uploads/payment/braintree.png'))); ?>"
                                                    class="img-center img-fluid p-1"
                                                    style="max-height: 100px;">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="braintree_pay_unfo"
                                                    class="form-label"><?php echo e(__('Description')); ?></label>
                                                <?php echo Form::textarea('braintree_pay_unfo', $setting['braintree_pay_unfo'] ?? '', [
                                                    'class' => 'autogrow form-control',
                                                    'rows' => '5',
                                                    'placeholder' => __('Enter Description'),
                            ...
                            <div id="collapseone_powertranz" class="accordion-collapse collapse"
                                ...
                                <div class="accordion-body">
                                    <div class="row mt-2">
                                        ...
                                        <div class="col-lg-12 pb-4">
                                            <label class="col-form-label"
                                                for="powertranz_mode"><?php echo e(__('PowerTranz Mode')); ?></label>
                                            <br>
                                            <div class="d-flex flex-wrap gap-2">
                                                <div class="mr-2" >
                                                    <div class="border card p-3">
                                                        <div class="form-check">
                                                            <label class="form-check-labe text-dark">
                                                                <input type="radio"
                                                                    ...
                                                                    class="form-check-input"
                                                                    checked="checked"
                                                                    <?php echo e((isset($setting['powertranz_mode']) && $setting['powertranz_mode'] == '') || (isset($setting['powertranz_mode']) && $setting['powertranz_mode'] == 'sandbox') ? 'checked="checked"' : ''); ?>>
                                                                <?php echo e(__('Sandbox')); ?>
                                                        ...
                                                        <div class="form-check">
                                                            <label class="form-check-labe text-dark">
                                                                <input type="radio"
                                                                    ...
                                                                    class="form-check-input"
                                                                    <?php echo e(isset($setting['powertranz_mode']) && $setting['powertranz_mode'] == 'production' ? 'checked="checked"' : ''); ?>>
                                                                <?php echo e(__('Production')); ?>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="powertranz_pay_merchant_id"
                                                    class="form-label"><?php echo e(__('PowerTranz Merchant ID')); ?></label>
                                                <input class="form-control"
                                                    placeholder="<?php echo e(__('Enter PowerTranz Merchant ID')); ?>"
                                                    name="powertranz_pay_merchant_id" type="text"
                                                    value="<?php echo e($setting['powertranz_pay_merchant_id'] ?? ''); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="powertranz_pay_processing_password"
                                                    class="form-label"><?php echo e(__('PowerTranz Processing Password')); ?></label>
                                                <input class="form-control"
                                                    placeholder="<?php echo e(__('Enter PowerTranz Processing Password')); ?>"
                                                    name="powertranz_pay_processing_password" type="text"
                                                    value="<?php echo e($setting['powertranz_pay_processing_password'] ?? ''); ?>">
                                            </div>
                                        </div>
                                        <div id="powertranz_pay_production_url" class="col-md-6" style="display: none;">
                                            <div class="form-group">
                                                <label for="powertranz_pay_url"
                                                    class="form-label"><?php echo e(__('PowerTranz Production url')); ?></label>
                                                <input class="form-control"
                                                    placeholder="<?php echo e(__('Enter PowerTranz Production url')); ?>"
                                                    name="powertranz_pay_production_url" type="text"
                                                    value="<?php echo e($setting['powertranz_pay_production_url'] ?? ''); ?>">
                                                    <small class="">
                                                        <?php echo e(__('Example')); ?>:
                                                        <?php echo e(__('https://TBD.ptranz.com')); ?>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <img alt="Image placeholder"
                                                src="<?php echo e(get_file($setting['powertranz_pay_image'] ?? Storage::url('uploads/payment/powertranz.png')) ?? asset(Storage::url('uploads/payment/powertranz.png'))); ?>"
                                                    class="img-center img-fluid p-1"
                                                    style="max-height: 100px;">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="powertranz_pay_unfo"
                                                    class="form-label"><?php echo e(__('Description')); ?></label>
                                                <?php echo Form::textarea('powertranz_pay_unfo', $setting['powertranz_pay_unfo'] ?? '', [
                                                    'class' => 'autogrow form-control',
                                                    'rows' => '5',
                                                    'placeholder' => __('Enter Description'),
                            ...
                            <div id="collapseone_sslcommerz" class="accordion-collapse collapse"
                                ...
                                <div class="accordion-body">
                                    <div class="row mt-2">
                                        ...
                                        <div class="col-lg-12 pb-4">
                                            <label class="col-form-label"
                                                for="sslcommerz_mode"><?php echo e(__('SSLCommerz Mode')); ?></label>
                                            <br>
                                            <div class="d-flex flex-wrap gap-2">
                                                <div class="mr-2" >
                                                    <div class="border card p-3">
                                                        <div class="form-check">
                                                            <label class="form-check-labe text-dark">
                                                                <input type="radio"
                                                                    ...
                                                                    class="form-check-input"
                                                                    checked="checked"
                                                                    <?php echo e((isset($setting['sslcommerz_mode']) && $setting['sslcommerz_mode'] == '') || (isset($setting['sslcommerz_mode']) && $setting['sslcommerz_mode'] == 'sandbox') ? 'checked="checked"' : ''); ?>>
                                                                <?php echo e(__('Sandbox')); ?>
                                                        ...
                                                        <div class="form-check">
                                                            <label class="form-check-labe text-dark">
                                                                <input type="radio"
                                                                    ...
                                                                    class="form-check-input"
                                                                    <?php echo e(isset($setting['sslcommerz_mode']) && $setting['sslcommerz_mode'] == 'live' ? 'checked="checked"' : ''); ?>>
                                                                <?php echo e(__('Live')); ?>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="sslcommerz_pay_store_id"
                                                    class="form-label"><?php echo e(__('SSLCommerz Store ID')); ?></label>
                                                <input class="form-control"
                                                    placeholder="<?php echo e(__('Enter SSLCommerz Store ID')); ?>"
                                                    name="sslcommerz_pay_store_id" type="text"
                                                    value="<?php echo e($setting['sslcommerz_pay_store_id'] ?? ''); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="sslcommerz_pay_secret_key"
                                                    class="form-label"><?php echo e(__('SSLCommerz Secret Key')); ?></label>
                                                <input class="form-control"
                                                    placeholder="<?php echo e(__('Enter SSLCommerz Secret Key')); ?>"
                                                    name="sslcommerz_pay_secret_key" type="text"
                                                    value="<?php echo e($setting['sslcommerz_pay_secret_key'] ?? ''); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <img alt="Image placeholder"
                                                src="<?php echo e(get_file($setting['sslcommerz_pay_image'] ?? Storage::url('uploads/payment/sslcommerz.png')) ?? asset(Storage::url('uploads/payment/sslcommerz.png'))); ?>"
                                                    class="img-center img-fluid p-1"
                                                    style="max-height: 100px;">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="sslcommerz_pay_unfo"
                                                    class="form-label"><?php echo e(__('Description')); ?></label>
                                                <?php echo Form::textarea('sslcommerz_pay_unfo', $setting['sslcommerz_pay_unfo'] ?? '', [
                                                    'class' => 'autogrow form-control',
                                                    'rows' => '5',
                                                    'placeholder' => __('Enter Description'),
...
<!-- End Payment Setting -->
<?php /**PATH B:\xampp\htdocs\ecommers\resources\views/setting/payment_setting.blade.php ENDPATH**/ ?>