    ...
    <div class="product-filter-column col-lg-3 col-md-4 col-12">
        <div class="product-filter-body">
            ...
            <div class="product-widget product-tag-widget">
                <div class="pro-itm has-children <?php echo e(count($sub_category_select) > 0 ? 'is-open' : ''); ?>">
                    <a href="javascript:;" class="acnav-label"><?php echo e(__('tags')); ?> </a>
                    <div class="pro-itm-inner acnav-list " style="<?php echo e(count($sub_category_select) > 0 ? 'display: block;  ' : ''); ?>">
                        <div class="d-flex flex-wrap text-checkbox">
                            <?php $__currentLoopData = $filter_tag; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub_category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="checkbox">
                                    <input id="<?php echo e($sub_category->id); ?>" name="product_tag" type="checkbox"
                                            class="product_tag" value="<?php echo e($sub_category->id); ?>"
                                            <?php echo e(in_array($sub_category->id, $sub_category_select) ? 'checked' : ''); ?> >
                                    <label for="<?php echo e($sub_category->id); ?>"
                                        class="checkbox-label"><?php echo e($sub_category->name); ?></label>
                                </div>
            ...
            <div class="product-widget product-price-widget">
                <div class="pro-itm has-children">
                    <a href="javascript:;" class="acnav-label"> <?php echo e(__('price')); ?> </a>
                    <div class="pro-itm-inner acnav-list">
                        <div class="price-select d-flex">
                            <?php $price_step = $max_price/5; ?>
                            <div class="select-col">
                                <p>
                                    <?php echo e(__('min price')); ?> : <span class="min_price_select" price="0"><?php echo e($currency_icon); ?> <?php echo e(0); ?></span>
                                </p>
                            </div>
                            <div class="select-col">
                                <p><?php echo e(__('max price')); ?> : <span class="max_price_select" price="<?php echo e($max_price); ?>"><?php echo e($currency_icon); ?> <?php echo e($max_price); ?></span> </p>
                            </div>
                        </div>
                        <div id="range-slider">
                            <div id="slider-range" class="slider-range" min_price="<?php echo e($min_price); ?>" max_price="<?php echo e($max_price); ?>" price_step="1" currency="<?php echo e($currency_icon); ?>" ></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="product-widget product-colors-widget">
                <div class="pro-itm has-children">
                    <a href="javascript:;" class="acnav-label"> <?php echo e(__('Rating')); ?> </a>
                    <div class="pro-itm-inner acnav-list">
            ...
            <div class="product-widget product-tag-widget">
                <div class="pro-itm has-children <?php echo e(count($brand_select) > 0 ? 'is-open' : ''); ?>">
                    <a href="javascript:;" class="acnav-label"><?php echo e(__('Brands')); ?> </a>
                    <div class="pro-itm-inner acnav-list " style="<?php echo e(count($brand_select) > 0 ? 'display: block;  ' : ''); ?>">
                        <div class="d-flex flex-wrap text-checkbox">
                            <?php $__currentLoopData = $brands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="checkbox">
                                    <input id="brand_<?php echo e($brand->id); ?>" name="brand_id" type="checkbox"
                                            class="product_brand" value="<?php echo e($brand->id); ?>"
                                            <?php echo e(in_array($brand->id, $brand_select) ? 'checked' : ''); ?> >
                                    <label for="brand_<?php echo e($brand->id); ?>"
                                        class="checkbox-label"><?php echo e($brand->name); ?></label>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    </div>
            ...
            <div class="product-widget product-filter-widget text-center">
                ...
                <button class="btn checkout-btn product_delete_filter_btn"  onclick="window.location='<?php echo e(route("page.product-list",$slug)); ?>'">
...
<script>
    $(document).ready(function() {
        ...
        if (!product_tag) {
            product_tag = '<?php echo e($product_tag); ?>';
        }
    ...
    function product_page_filter(page) {
        ...
        $.ajax({
            url: '<?php echo e(route('product.page.filter', $slug)); ?>?page='+ page + '&' + queryString,
            context: this,
...
<?php $__env->stopPush(); ?><?php /**PATH B:\xampp\htdocs\ecommers\resources\views/front_end/common/product/filter.blade.php ENDPATH**/ ?>