            ...
            <div class="col-md-6 col-lg-4 col-12">
                <div class="testimonials-left-inner">
                    <div class="section-title">
                        <h2 class="title" id="<?php echo e($section->review->section->title->slug ?? ''); ?>_preview"><?php echo $section->review->section->title->text ?? ''; ?></h2>
                    </div>
                    <p id="<?php echo e($section->review->section->description->slug ?? ''); ?>_preview"><?php echo $section->review->section->description->text ?? ''; ?> </p>
                    <a href="#" class="btn" id="<?php echo e($section->review->section->button->slug ?? ''); ?>_preview">
                        ...
                        <?php echo e($section->review->section->button->text ?? ''); ?> <svg xmlns="http://www.w3.org/2000/svg"
                        ...
                        <div class="testimonials-card">
                            <div class="testimonials-inner">
                                <div class="top-card">
                                    <div class="reviews-stars-wrap d-flex align-items-center">
                                        ...
                                        <div class="point-wrap">
                                            <span class="review-point"><?php echo e($review->rating_no); ?>.0 /
                                                <span>5.0</span></span>
                                        </div>
                                    </div>
                                    <div class="reviews-words">
                                        <h3 class="main-word name"><?php echo e($review->title); ?></h3>
                                ...
                                <div class="reviewer-profile">
                                    ...
                                    <span><b><?php echo e(!empty($review->UserData) ? ($review->UserData->first_name ? $review->UserData->first_name.',' : '') : ''); ?></b>
                                             <p><a href="#"
                                                    tabindex="0"><?php echo e($review->ProductData->name ?? ''); ?></a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
...
</section><?php /**PATH B:\xampp\htdocs\ecommers\themes\grocery\views/front_end/sections/homepage/review_section.blade.php ENDPATH**/ ?>