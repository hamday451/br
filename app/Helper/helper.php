...
if (!function_exists('GetCurrenctTheme')) {
    function GetCurrenctTheme($storeSlug)
    {
        ...
        if ($storeSlug == null) {
            ...
            $store = Cache::remember('store_' . $store_id, 3600, function () {
...
if (!function_exists('getHomePageDatabaseSectionDataFromDatabase')) {
    function getHomePageDatabaseSectionDataFromDatabase($data)
    {
        ...
        $resultData = compact('categories', 'latest_product', 'landing_product', 'search_products',
            'MainCategoryList', 'SubCategoryList', 'reviews', 'category_id',
            'has_subcategory', 'discount_products', 'products', 'all_products',
            'modern_products', 'home_products', 'home_page_products',
            'random_product', 'bestSeller', 'all_slider_products', 'best_categories','MainCategory');
...
if (!function_exists('getInnerPageJson')) {
    ...
    {
        $page_names = ['order-complete', 'product_page', 'blog_page', 'cart_page', 'checkout_page', 'contact_page', 'faq_page', 'collection_page', 'article_page','common_page']; // Correct the typo
        $default_paths = [
