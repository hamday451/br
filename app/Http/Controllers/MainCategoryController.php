...
class MainCategoryController extends Controller
{
    ...
    public function getProductCategories()
    {
        ...
        $html = '<div class="col-xxl-2 col-lg-3  col-sm-4 mb-3  zoom-in ">
                    <div class="mb-0 h-100 cat-active overflow-hidden" data-id="0">
                    <div class="category-select h-100" data-cat-id="0">
                        <button type="button" class="btn h-100 w-100 btn-primary btn-sm rounded-3 active">'.__("All Categories").'</button>
                    </div>
                    </div>
                </div>';
        foreach($productCategory as $key => $cat){
            $dcls = 'category-select';
            $html .= ' <div class="col-xxl-2 col-lg-3  col-sm-4 mb-3  zoom-in cat-list-btn">
            <div class="mb-0 h-100 overflow-hidden" data-id="'.$cat->id.'">
               <div class="h-100 '.$dcls.'" data-cat-id="'.$cat->id.'">
                  <button type="button" class="btn h-100 w-100 btn-primary btn-sm rounded-3 ">'.$cat->name.'</button>
               </div>
            </div>
         </div>';
