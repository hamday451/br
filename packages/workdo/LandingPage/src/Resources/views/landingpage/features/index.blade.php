                            ...
                            <div class="card-header">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-3 all-button-box justify-content-end d-flex">
                                        <a href="#" data-size="lg" data-url="{{ route('feature_create') }}" data-ajax-popup="true" data-bs-toggle="tooltip" title="{{__('Add Feature')}}" data-title="{{__('Create Feature')}}" class="btn btn-sm btn-primary btn-badge">
