...
@section('action-button')
    <div class="text-end d-flex flex-wrap all-button-box align-items-center btn-badge justify-content-md-end justify-content-center gap-2">
        <a href="{{ route('store.subdomain') }}" class="btn btn-sm btn-primary btn-icon me-1" data-bs-toggle="tooltip"
            data-bs-placement="top" title="{{ __('Sub Domain') }}">{{ __('Sub Domain') }}</a>

        <a href="{{ route('store.customdomain') }}" class="btn btn-sm btn-primary btn-badge btn-icon me-1" data-bs-toggle="tooltip"
