            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <input type="hidden" name="array[section][background_image][lable]" class="form-control" value="{{ $json_data->section->service_image->lable ?? '' }}">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <input type="hidden" name="array[section][background_image][lable]" class="form-control" value="{{ $json_data->section->service_second_image->lable ?? '' }}">
                    ...
                    <div class="form-group">
                        ...
                        <div id="file_upload_section" style="display: {{ $json_data->section->video->type == 'file' ? 'block' : 'none' }}">
                            ...
                            @if($json_data->section->video->image)
                                <video src="{{ asset($json_data->section->video->image) }}" controls loop autoplay muted></video>
                            @endif
                        </div>
                        ...
                        <div id="link_upload_section" style="display: {{ $json_data->section->video->type == 'text' ? 'block' : 'none' }}">
                            ...
                            @if($json_data->section->video->text)
                                <video src="{{ $json_data->section->video->text }}" controls loop autoplay muted></video>
                            @endif
                        </div>
                    </div>
                </div>
